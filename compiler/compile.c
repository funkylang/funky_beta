...
enum {
  ...
  var_on, // extern
  var_80_1_first_statement, // dynamic
  var_is_a_remark, // extern
  var_text_of, // extern
  var_has_prefix, // extern
  var_81_1_is_a_main_module, // dynamic
  var_std__and, // extern
  ...
  var_148_30_statements, // dynamic
  var_149_1_i, // dynamic
  var_150_1_n, // dynamic
  var_length_of, // extern
  var_151_1_defined_namespaces, // dynamic
  var_empty_insert_order_table, // extern
  var_152_1_required_modules, // dynamic
  var_empty_insert_order_set, // extern
  var_153_1_used_namespaces, // dynamic
  var_154_1_namespace_versions, // dynamic
  var_155_1_namespace_aliases, // dynamic
  var_156_1_allow_hidden, // dynamic
  var_false, // extern
  var_157_1_allow_unused, // dynamic
  var_std__less, // extern
  var_171_1_statement, // dynamic
  var_node_type_of, // extern
  var_NAMESPACE_INSTRUCTION, // extern
  var_174_1_namespace_name, // dynamic
  var_funky__name_of, // extern
  var_175_1_version, // dynamic
  var_version_of, // extern
  var_176_4_major, // dynamic
  var_176_11_minor, // dynamic
  var_UNSTABLE, // extern
  ...
  var_192_1_required_module, // dynamic
  var_filename_of, // extern
  var_until, // extern
  var_range, // extern
  var_true, // extern
  var_USING_INSTRUCTION, // extern
  var_207_1_used_namespace, // dynamic
  var_208_1_version, // dynamic
  var_209_4_major, // dynamic
  var_209_11_minor, // dynamic
  var_RESOLVE_INSTRUCTION, // extern
  var_221_1_resolved_namespace, // dynamic
  var_222_1_version, // dynamic
  var_ALIAS_INSTRUCTION, // extern
  var_236_1_alias, // dynamic
  var_alias_of, // extern
  var_237_1_name, // dynamic
  ...
  var_299_1_head, // dynamic
  var_head_of, // extern
  var_300_1_arguments, // dynamic
  ...
  var_323_16_node, // dynamic
  var_324_1_identifier, // dynamic
...
static TAB_NUM t_func_funky__compile_module[] = {
  ...
  var_without_prefix, 2, var_60_25_filename, var_base_directory, 1, var_60_25_filename,
  // is_defined &filename
  var_is_defined, 1, var_module_prefix, 1, LOCAL(1),
  // update_if module_prefix.is_defined &filename
  var_update_if, 3, LOCAL(1), var_60_25_filename, lambda_1, 1, var_60_25_filename,
  // !current_filename filename
  LET, 1, var_60_25_filename, 1, var_current_filename,
  // filename .without_suffix. ".fky"
  var_without_suffix, 2, var_60_25_filename, str_fky, 1, LOCAL(1),
  // !current_module_name
  var_replace_all, 2, LOCAL(1), key_value_pair_70_1, 1, var_current_module_name,
  // parse $statements lines parse_top_level_statement_group
  var_parse, 2, LOCAL(3), var_parse_top_level_statement_group, 1, var_71_7_statements,
  // is_undefined:
  var_is_undefined, 1, var_71_7_statements, 1, LOCAL(1),
  // on statements.is_undefined:
  var_on, 2, LOCAL(1), lambda_2, 0,
  // $first_statement statements(1)
  var_71_7_statements, 1, num_1, 1, var_80_1_first_statement,
  // is_a_remark
  var_is_a_remark, 1, var_80_1_first_statement, 1, LOCAL(1),
  // $is_a_main_module
  var_std__and, 2, LOCAL(1), lambda_3, 1, var_81_1_is_a_main_module,
  // retrieve_meta_instructions &statements
  func_retrieve_meta_instructions, 1, var_71_7_statements, 8, var_71_7_statements, var_defined_namespaces, var_required_modules, var_used_namespaces, var_namespace_versions, var_namespace_aliases, var_allow_hidden, var_allow_unused,
  ...
  func_collect_global_definitions, 1, var_71_7_statements, 1, var_resolve_variable,
  // update_if is_a_main_module &redefined_variables:
  var_update_if, 3, var_81_1_is_a_main_module, var_redefined_variables, lambda_6, 1, var_redefined_variables,
  // map_reduce &statements simplify_statement append empty_list
  var_map_reduce, 4, var_71_7_statements, var_simplify_statement, var_append, var_empty_list, 1, var_71_7_statements,
  // collect_variables !variables statements
  var_collect_variables, 1, var_71_7_statements, 1, var_variables,
  ...
  var_collect_literals, 1, var_71_7_statements, 1, var_literals,
  // generate_tabular_code statements is_a_main_module
  var_generate_tabular_code, 2, var_71_7_statements, var_81_1_is_a_main_module, TAIL_CALL,
  POS(63, 3),
  POS(64, 27),
  POS(64, 3),
  POS(66, 3),
...
static TAB_NUM t_lambda_1[] = {
  ...
  var_append, 3, var_module_prefix, string_1, var_60_25_filename, 1, LOCAL(1),
  //  append(module_prefix "/" filename)
...
static TAB_NUM t_lambda_3[] = {
  ...
  var_text_of, 1, var_80_1_first_statement, 1, LOCAL(1),
  // text_of(first_statement) .has_prefix. '!'
...
static TAB_NUM t_lambda_4[] = {
  ...
  0, // parameters
  // is_a_main_module
  LET, 1, var_81_1_is_a_main_module, TAIL_CALL,
  POS(91, 42)
};
...
static TAB_NUM t_lambda_5[] = {
  ...
  var_hash_table, 1, key_value_pair_94_15, 1, LOCAL(3),
  //  hash_table("std" = tuple(1 0))
...
static TAB_NUM t_lambda_6[] = {
  ...
  func_collect_global_redefinitions, 1, var_71_7_statements, TAIL_CALL,
  POS(98, 5)
};
...
static TAB_NUM t_func_retrieve_meta_instructions[] = {
  0, // locals
  1, // parameters
  var_148_30_statements,
  // $i 1
  LET, 1, num_1, 1, var_149_1_i,
  // $n length_of(statements)
  var_length_of, 1, var_148_30_statements, 1, var_150_1_n,
  // $defined_namespaces empty_insert_order_table
  LET, 1, var_empty_insert_order_table, 1, var_151_1_defined_namespaces,
  // $required_modules empty_insert_order_set
  LET, 1, var_empty_insert_order_set, 1, var_152_1_required_modules,
  // $used_namespaces empty_insert_order_table
  LET, 1, var_empty_insert_order_table, 1, var_153_1_used_namespaces,
  // $namespace_versions empty_insert_order_table
  LET, 1, var_empty_insert_order_table, 1, var_154_1_namespace_versions,
  // $namespace_aliases empty_insert_order_table
  LET, 1, var_empty_insert_order_table, 1, var_155_1_namespace_aliases,
  // $allow_hidden false
  LET, 1, var_false, 1, var_156_1_allow_hidden,
  // $allow_unused false
  LET, 1, var_false, 1, var_157_1_allow_unused,
  // loop:
...
static TAB_NUM t_lambda_loop[] = {
  ...
  0, // parameters
  // n
  var_std__less, 2, var_150_1_n, var_149_1_i, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_7[] = {
  ...
  0, // parameters
  // 
  LET, 8, var_empty_list, var_151_1_defined_namespaces, var_152_1_required_modules, var_153_1_used_namespaces, var_154_1_namespace_versions, var_155_1_namespace_aliases, var_156_1_allow_hidden, var_157_1_allow_unused, TAIL_CALL,
  POS(161, 9)
};
...
static TAB_NUM t_lambda_8[] = {
  ...
  var_148_30_statements, 1, var_149_1_i, 1, var_171_1_statement,
  // node_type_of(statement)
  var_node_type_of, 1, var_171_1_statement, 1, LOCAL(1),
...
static TAB_NUM t_lambda_NAMESPACE_INSTRUCTION[] = {
  ...
  var_funky__name_of, 1, var_171_1_statement, 1, var_174_1_namespace_name,
  // $version version_of(statement)
  var_version_of, 1, var_171_1_statement, 1, var_175_1_version,
  // is_defined:
  var_is_defined, 1, var_175_1_version, 1, LOCAL(1),
  // if $major $minor
  var_if, 3, LOCAL(1), lambda_version_is_defined, lambda_11, 2, var_176_4_major, var_176_11_minor,
  // "-@(major)"
  var_std__string, 2, string_5, var_176_4_major, 1, LOCAL(1),
  // append &namespace_name "-@(major)"
  var_append, 2, var_174_1_namespace_name, LOCAL(1), 1, var_174_1_namespace_name,
  // defined_namespaces(namespace_name).is_defined:
  var_151_1_defined_namespaces, 1, var_174_1_namespace_name, 1, LOCAL(1),
  // is_defined:
...
static TAB_NUM t_lambda_version_is_defined[] = {
  ...
  var_node_type_of, 1, var_175_1_version, 1, LOCAL(1),
  // node_type_of(version) == UNSTABLE
...
static TAB_NUM t_lambda_10[] = {
  ...
  var_major_of, 1, var_175_1_version, 1, LOCAL(1),
  // minor_of(version)
  var_minor_of, 1, var_175_1_version, 1, LOCAL(2),
  //  major_of(version) minor_of(version)
...
static TAB_NUM t_lambda_defined_namespacesnamespace_name_is_defined[] = {
  ...
  var_syntax_error, 2, str_Namespace_is_alr, var_171_1_statement, TAIL_CALL,
  POS(186, 17)
};
...
static TAB_NUM t_lambda_12[] = {
  ...
  var_tuple, 2, var_176_4_major, var_176_11_minor, 1, LOCAL(2),
  // defined_namespaces(namespace_name) tuple(major minor)
  var_151_1_defined_namespaces, 2, var_174_1_namespace_name, LOCAL(2), 1, var_151_1_defined_namespaces,
  // inc &i
  var_inc, 1, var_149_1_i, 1, var_149_1_i,
  // next
...
static TAB_NUM t_lambda_REQUIRE_INSTRUCTION[] = {
  ...
  var_filename_of, 1, var_171_1_statement, 1, var_192_1_required_module,
  // required_module .has_prefix. "./" &required_module:
  var_has_prefix, 2, var_192_1_required_module, string_6, 1, LOCAL(1),
  // update_if required_module .has_prefix. "./" &required_module:
  var_update_if, 3, LOCAL(1), var_192_1_required_module, lambda_13, 1, var_192_1_required_module,
  // required_modules(required_module):
  var_152_1_required_modules, 1, var_192_1_required_module, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_13[] = {
  ...
  var_range, 3, var_192_1_required_module, num_3, minus_num_1, 1, LOCAL(2),
  // append
...
static TAB_NUM t_lambda_required_modulesrequired_module[] = {
  ...
  var_syntax_error, 2, str_Module_is_alread, var_171_1_statement, TAIL_CALL,
  POS(201, 17)
};
...
static TAB_NUM t_lambda_14[] = {
  ...
  var_152_1_required_modules, 2, var_192_1_required_module, var_true, 1, var_152_1_required_modules,
  // inc &i
  var_inc, 1, var_149_1_i, 1, var_149_1_i,
  // next
  var_next, 0, TAIL_CALL,
...
static TAB_NUM t_lambda_USING_INSTRUCTION[] = {
  ...
  var_funky__name_of, 1, var_171_1_statement, 1, var_207_1_used_namespace,
  // $version version_of(statement)
  var_version_of, 1, var_171_1_statement, 1, var_208_1_version,
  // is_defined
  var_is_defined, 1, var_208_1_version, 1, LOCAL(1),
  // if $major $minor
  var_if, 3, LOCAL(1), lambda_15, lambda_16, 2, var_209_4_major, var_209_11_minor,
  // used_namespaces(used_namespace).is_defined:
  var_153_1_used_namespaces, 1, var_207_1_used_namespace, 1, LOCAL(1),
  // is_defined:
  var_is_defined, 1, LOCAL(1), 1, LOCAL(2),
  // if
...
static TAB_NUM t_lambda_15[] = {
  ...
  0, // parameters
  // major_of(version) minor_of(version)
  var_major_of, 1, var_208_1_version, 1, LOCAL(1),
  // minor_of(version)
  var_minor_of, 1, var_208_1_version, 1, LOCAL(2),
  //  major_of(version) minor_of(version)
  LET, 2, LOCAL(1), LOCAL(2), TAIL_CALL,
  POS(211, 18),
  POS(211, 36),
...
static TAB_NUM t_lambda_used_namespacesused_namespace_is_defined[] = {
  ...
  var_syntax_error, 2, str_Namespace_is_alr_2, var_171_1_statement, TAIL_CALL,
  POS(215, 17)
};
...
static TAB_NUM t_lambda_17[] = {
  ...
  var_tuple, 2, var_209_4_major, var_209_11_minor, 1, LOCAL(2),
  // used_namespaces(used_namespace) tuple(major minor)
  var_153_1_used_namespaces, 2, var_207_1_used_namespace, LOCAL(2), 1, var_153_1_used_namespaces,
  // inc &i
  var_inc, 1, var_149_1_i, 1, var_149_1_i,
  // next
  var_next, 0, TAIL_CALL,
...
static TAB_NUM t_lambda_RESOLVE_INSTRUCTION[] = {
  ...
  var_funky__name_of, 1, var_171_1_statement, 1, var_221_1_resolved_namespace,
  // $version version_of(statement)
  var_version_of, 1, var_171_1_statement, 1, var_222_1_version,
  // namespace_versions(resolved_namespace).is_defined:
  var_154_1_namespace_versions, 1, var_221_1_resolved_namespace, 1, LOCAL(1),
  // is_defined:
  var_is_defined, 1, LOCAL(1), 1, LOCAL(2),
  // if
...
static TAB_NUM t_lambda_namespace_versionsresolved_namespace_is_defined[] = {
  ...
  var_syntax_error, 2, str_Namespace_is_alr_3, var_171_1_statement, TAIL_CALL,
  POS(225, 17)
};
...
static TAB_NUM t_lambda_18[] = {
  ...
  0, // parameters
  // node_type_of(version) == UNSTABLE
  var_node_type_of, 1, var_222_1_version, 1, LOCAL(1),
  // node_type_of(version) == UNSTABLE
  var_std__equal, 2, LOCAL(1), var_UNSTABLE, 1, LOCAL(2),
  // !version
  var_if, 3, LOCAL(2), lambda_19, lambda_20, 1, var_222_1_version,
  // namespace_versions(resolved_namespace) version
  var_154_1_namespace_versions, 2, var_221_1_resolved_namespace, var_222_1_version, 1, var_154_1_namespace_versions,
  // inc &i
  var_inc, 1, var_149_1_i, 1, var_149_1_i,
  // next
  var_next, 0, TAIL_CALL,
...
static TAB_NUM t_lambda_20[] = {
  ...
  0, // parameters
  // major_of(version)).@(minor_of(version))"
  var_major_of, 1, var_222_1_version, 1, LOCAL(1),
  // minor_of(version))"
  var_minor_of, 1, var_222_1_version, 1, LOCAL(2),
  // "@(major_of(version)).@(minor_of(version))"
...
static TAB_NUM t_lambda_ALIAS_INSTRUCTION[] = {
  ...
  var_alias_of, 1, var_171_1_statement, 1, var_236_1_alias,
  // $name funky::name_of(statement)
  var_funky__name_of, 1, var_171_1_statement, 1, var_237_1_name,
  // namespace_aliases(alias).is_defined:
  var_155_1_namespace_aliases, 1, var_236_1_alias, 1, LOCAL(1),
  // is_defined:
  var_is_defined, 1, LOCAL(1), 1, LOCAL(2),
  // if
...
static TAB_NUM t_lambda_namespace_aliasesalias_is_defined[] = {
  ...
  var_syntax_error, 2, str_Redefinition_of, var_171_1_statement, TAIL_CALL,
  POS(240, 17)
};
...
static TAB_NUM t_lambda_21[] = {
  ...
  var_155_1_namespace_aliases, 2, var_236_1_alias, var_237_1_name, 1, var_155_1_namespace_aliases,
  // inc &i
  var_inc, 1, var_149_1_i, 1, var_149_1_i,
  // next
  var_next, 0, TAIL_CALL,
...
static TAB_NUM t_lambda_ALLOW_INSTRUCTION[] = {
  ...
  0, // parameters
  // pragma_of(statement))
  var_pragma_of, 1, var_171_1_statement, 1, LOCAL(1),
...
static TAB_NUM t_lambda_ALLOW_HIDDEN[] = {
  ...
  0, // parameters
  // on allow_hidden:
  var_on, 2, var_156_1_allow_hidden, lambda_22, 0,
  // !allow_hidden true
  LET, 1, var_true, 1, var_156_1_allow_hidden,
  // inc &i
  var_inc, 1, var_149_1_i, 1, var_149_1_i,
  // next
  var_next, 0, TAIL_CALL,
...
static TAB_NUM t_lambda_22[] = {
  ...
  var_syntax_error, 2, str_Allow_hidden_was, var_171_1_statement, TAIL_CALL,
  POS(249, 19)
};
...
static TAB_NUM t_lambda_ALLOW_UNUSED[] = {
  ...
  0, // parameters
  // on allow_unused:
  var_on, 2, var_157_1_allow_unused, lambda_23, 0,
  // !allow_unused true
  LET, 1, var_true, 1, var_157_1_allow_unused,
  // inc &i
  var_inc, 1, var_149_1_i, 1, var_149_1_i,
  // next
  var_next, 0, TAIL_CALL,
...
static TAB_NUM t_lambda_23[] = {
  ...
  var_syntax_error, 2, str_Allow_unused_was, var_171_1_statement, TAIL_CALL,
  POS(255, 19)
};
...
static TAB_NUM t_lambda_24[] = {
  ...
  var_range, 3, var_148_30_statements, var_149_1_i, minus_num_1, 1, LOCAL(1),
  // 
  LET, 8, LOCAL(1), var_151_1_defined_namespaces, var_152_1_required_modules, var_153_1_used_namespaces, var_154_1_namespace_versions, var_155_1_namespace_aliases, var_156_1_allow_hidden, var_157_1_allow_unused, TAIL_CALL,
  POS(263, 13),
  POS(262, 13)
};
...
static TAB_NUM t_func_funky_types__statement___add_definitions[] = {
  ...
  LOCAL(4), // 298_42_self
  // $head head_of(self)
  var_head_of, 1, LOCAL(4), 1, var_299_1_head,
  // $arguments arguments_of(self)
  var_arguments_of, 1, LOCAL(4), 1, var_300_1_arguments,
  // node_type_of(head) == DEFINITION
  var_node_type_of, 1, var_299_1_head, 1, LOCAL(1),
  // node_type_of(head) == DEFINITION
...
static TAB_NUM t_lambda_26[] = {
  ...
  0, // parameters
  // is_not_empty
  var_is_not_empty, 1, var_300_1_arguments, 1, LOCAL(1),
  // 
...
static TAB_NUM t_lambda_27[] = {
  ...
  var_300_1_arguments, 1, num_1, 1, LOCAL(1),
...
static TAB_NUM t_lambda_28[] = {
  ...
  func_add_variable, 1, var_299_1_head, 1, var_resolve_variable,
  // resolve_arguments
...
static TAB_NUM t_func_resolve_arguments[] = {
  ...
  var_for_each, 3, var_300_1_arguments, var_add_definition, var_next, TAIL_CALL,
  POS(312, 5)
};
...
static TAB_NUM t_func_add_variable[] = {
  ...
  var_identifier_of, 1, var_323_16_node, 1, var_324_1_identifier,
  ...
  var_resolve_variable, 2, var_324_1_identifier, var_324_1_identifier, 1, LOCAL(1),
  // -> resolve_variable(identifier identifier)
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(324, 3),
  POS(325, 6),
...
static TAB_NUM t_lambda_29[] = {
  ...
  var_resolve_variable, 1, var_324_1_identifier, 1, LOCAL(1),
  // is_defined:
  var_is_defined, 1, LOCAL(1), 1, LOCAL(2),
  // resolve_variable(identifier).is_defined:
  LET, 1, LOCAL(2), TAIL_CALL,
...
static TAB_NUM t_lambda_30[] = {
  ...
  var_syntax_error, 2, str_Variable_is_alre, var_323_16_node, TAIL_CALL,
  POS(326, 5)
};
...
static TAB_NUM t_func_add_identifier_redefinition[] = {
  ...
  var_identifier_of, 1, LOCAL(2), 1, var_351_1_identifier,
  // identifier .contains. ':'
  var_contains, 2, var_351_1_identifier, chr_58, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_32[] = {
  ...
  var_redefined_variables, 2, var_351_1_identifier, var_true, 1, var_redefined_variables,
  // next
  var_next, 0, TAIL_CALL,
  POS(356, 8),
  POS(357, 7)
...
static int tuple_94_22_arguments[] = {
  -num_1, -num_0
};

static int key_value_pair_94_15_arguments[] = {
  -str_std, -tuple_94_22
};
...
static FUNKY_CONSTANT constants_table[] = {
  ...
  {FLT_TUPLE, 2, {.arguments = tuple_94_22_arguments}},
  {FLT_STRING_8, 3, {.str_8 = "std"}},
  {FLT_KEY_VALUE_PAIR, 2, {.arguments = key_value_pair_94_15_arguments}},
  ...
  {FLT_FUNCTION, 0, {.tfunc = t_func_add_variable}},
...
static FUNKY_VARIABLE variables_table[] = {
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "81_1_is_a_main_module\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "and\000std", NULL,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "151_1_defined_namespaces\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "152_1_required_modules\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "153_1_used_namespaces\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "154_1_namespace_versions\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "155_1_namespace_aliases\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "156_1_allow_hidden\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "false\000", NULL,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "176_4_major\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "176_11_minor\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "UNSTABLE\000", NULL,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "192_1_required_module\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "207_1_used_namespace\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "208_1_version\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "209_4_major\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "209_11_minor\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "221_1_resolved_namespace\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "222_1_version\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "323_16_node\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "324_1_identifier\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
