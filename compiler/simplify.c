...
enum {
  ...
  lambda_87 = -232,
  lambda_88 = -233,
  func_simplify_head_and_arguments = -234,
  lambda_89 = -235,
  lambda_90 = -236,
  lambda_91 = -237,
  lambda_92 = -238,
  ...
  lambda_94 = -240,
  lambda_95 = -241,
  lambda_is_an_assignment = -242,
  lambda_96 = -243,
  lambda_97 = -244,
  lambda_is_a_slot_definition = -245,
  str_const = -246,
  lambda_98 = -247,
  func_check_trailing_statements = -248,
  lambda_99 = -249,
  str_stdassign = -250,
  lambda_100 = -251,
  func_process_trailing_statements = -252,
  lambda_101 = -253,
  lambda_102 = -254,
  lambda_2_FUNCTOR = -255,
  lambda_103 = -256,
  lambda_INLINE_ATTRIBUTE_VALUE_PAIR = -257,
  lambda_104 = -258,
  lambda_105 = -259,
  str_TEMP_NOT_FOUND_I = -260,
  lambda_106 = -261,
  lambda_107 = -262,
  lambda_108 = -263,
  func_check_that_all_arguments_are_inputs = -264,
  lambda_109 = -265,
  str_Unexpected_outpu = -266,
  func_is_a_pair_or_type_function = -267,
  lambda_110 = -268,
  lambda_111 = -269,
  func_funky_types__numeric_literal___simplify = -270,
  chr_39 = -271,
  chr_46 = -272,
  string_2 = -273,
  key_value_pair_947_1 = -274,
  key_value_pair_948_1 = -275,
  str_num = -276,
  func_funky_types__character_literal___simplify = -277,
  func_funky_types__numeric_character_literal___simplify = -278,
  str_chr = -279,
  func_funky_types__named_character_literal___simplify = -280,
  lambda_112 = -281,
  lambda_113 = -282,
  str_Invalid_characte = -283,
  func_funky_types__at_character_literal___simplify = -284,
  string_3 = -285,
  func_create_numeric_character_literal = -286,
  func_funky_types__unique___simplify = -287,
  chr_32 = -288,
  str_uni = -289,
  func_funky_types__string_literal___simplify = -290,
  string_4 = -291,
  lambda_114 = -292,
  str_string = -293,
  lambda_115 = -294,
  lambda_116 = -295,
  lambda_CHARACTER_SEQUENCE = -296,
  lambda_117 = -297,
  lambda_118 = -298,
  lambda_119 = -299,
  lambda_NUMERIC_CHARACTER = -300,
  lambda_NAMED_CHARACTER = -301,
  lambda_120 = -302,
  lambda_NEWLINE = -303,
  chr_10 = -304,
  lambda_AT_CHARACTER = -305,
  chr_64 = -306,
  lambda_ESCAPE_EXPRESSION = -307,
  lambda_TAGGED_EMPTY_CHARACTER = -308,
  lambda_121 = -309,
  str_node_type_ofcomp = -310,
  lambda_122 = -311,
  lambda_123 = -312,
  lambda_124 = -313,
  lambda_125 = -314,
  str_stdstring = -315,
  func_add_characters = -316,
  lambda_126 = -317,
  lambda_127 = -318,
  str_string_2 = -319,
  func_std_types__list___simplify = -320,
  lambda_128 = -321,
  lambda_129 = -322,
  func_create_functor = -323,
  func_std = -324,
  str_std = -325,
  func_assign_attributes = -326,
  str__assign_attribut = -327,
  func_temporary = -328,
  str__temp = -329,
  func_redefine_temporary = -330,
  func_update_temporary = -331,
  func_create_statement = -332,
  lambda_arguments_is_not_empty = -333,
  lambda_130 = -334,
  lambda_131 = -335,
  lambda_132 = -336,
  lambda_133 = -337,
  func_expand_backquotes = -338,
  lambda_134 = -339,
  lambda_135 = -340,
  lambda_136 = -341,
  lambda_137 = -342,
  func_resolve_backquoted = -343,
  func_exctract_characters = -344,
  lambda_138 = -345,
  lambda_nl = -346,
  lambda_139 = -347,
  lambda_140 = -348,
  ...
  chr_41 = -354,
  lambda_143 = -355,
  func_funky_types__statement_list___append = -356,
  func_funky_types__statement_list___push_leading_statement = -357,
  func_funky_types__statement_list___push_trailing_statement = -358,
  func_collect_parameter_definitions = -359,
  lambda_144 = -360,
  func_collect_local_definitions = -361,
  lambda_145 = -362,
  func_funky_types__node___add_definitions = -363,
  func_funky_types__statement___add_definitions = -364,
  func_funky_types__node___add_definition = -365,
  func_funky_types__definition___add_definition = -366,
  lambda_146 = -367,
  lambda_147 = -368,
  str_Variable_is_alre = -369,
  func_add_parameter_definition = -370,
  func_funky__mangle_local_definition = -371,
  func_funky__mangle_position = -372
};
...
enum {
  ...
  var_783_1_is_a_slot_assigment, // dynamic
  var_784_1_arguments, // dynamic
  var_FUNCTOR, // extern
  var_RETURN, // extern
  var_810_31_is_an_assignment, // dynamic
  var_811_25_result_statements, // dynamic
  var_812_1_new_arguments, // dynamic
  var_814_3_item, // dynamic
  var_BACKQUOTED, // extern
  var_833_19_leading_statements, // dynamic
  var_833_39_trailing_statements, // dynamic
  var_834_1_is_a_slot_definition, // dynamic
  var_841_1_last_statement, // dynamic
  var_line_no_of, // extern
  var_CONSTANT_COMPOUND, // extern
  var_885_1_temp_name, // dynamic
  var_886_1_value, // dynamic
  var_888_3_stmt_idx, // dynamic
  var_888_12_trailing_statement, // dynamic
  var_890_3_arg_idx, // dynamic
  var_890_11_argument, // dynamic
  var_INLINE_ATTRIBUTE_VALUE_PAIR, // extern
  var_debug__print, // extern
  var_is_an_output, // extern polymorphic
  var_930_1_argument, // dynamic
  var_find_first, // extern
  var_935_1_node_type, // dynamic
  ...
  var_971_49_self, // dynamic
  var_971_54_temp_no, // dynamic
  var_972_1_chr, // dynamic
  ...
  var_1006_40_self, // dynamic
  var_1006_45_temp_no, // dynamic
  var_1007_1_arguments, // dynamic
  var_1008_1_characters, // dynamic
  var_1009_1_statements, // dynamic
  var_1010_1_components, // dynamic
  var_components_of, // extern
  var_funky_types__character_sequence, // extern
  var_characters_of, // extern polymorphic
  var_1023_3_idx, // dynamic
  var_1023_7_component, // dynamic
  var_CHARACTER_SEQUENCE, // extern
  var_1026_1_component_characters, // dynamic
  ...
  var_1103_33_temp_no, // dynamic
  var_1104_1_statements, // dynamic
  var_1105_1_simplified_nodes, // dynamic
  var_TEMPORARY, // extern
  var_1170_20_head, // dynamic
  var_1170_25_arguments, // dynamic
  var_1173_1_node_type, // dynamic
  var_1197_1_expanded, // dynamic
  var_1199_3_argument, // dynamic
  var_1219_23_str, // dynamic
  var_1220_1_level, // dynamic
  var_1221_1_within_string, // dynamic
  var_1222_15_idx, // dynamic
  var_dec, // extern
  var_add_definition, // attribute
  var_add_definitions, // attribute
  var_1281_42_self, // dynamic
  var_1282_1_identifier, // dynamic
...
static TAB_NUM t_func_funky_types__statement___simplify[] = {
  ...
  // $is_a_slot_assigment false
  LET, 1, var_false, 1, var_783_1_is_a_slot_assigment,
  // arguments_of(self): (argument) -> not(argument.is_a_remark)
  var_arguments_of, 1, var_779_35_self, 1, LOCAL(1),
  // $arguments
  var_filter, 2, LOCAL(1), lambda_arguments_ofself, 1, var_784_1_arguments,
  // node_type_of(head)
...
static TAB_NUM t_lambda_80[] = {
  ...
  0, // parameters
  // $n length_of(arguments)
  var_length_of, 1, var_784_1_arguments, 1, LOCAL(3),
  ...
  var_on, 2, LOCAL(1), lambda_81, 0,
  // arguments(1))
  var_784_1_arguments, 1, num_1, 1, LOCAL(1),
  // !is_a_slot_assigment is_a_pair_or_type_function(arguments(1))
  func_is_a_pair_or_type_function, 1, LOCAL(1), 1, var_783_1_is_a_slot_assigment,
  ...
  func_check_that_all_arguments_are_inputs, 0, 0,
  // push &arguments head
  var_push, 2, var_784_1_arguments, var_780_1_head, 1, var_784_1_arguments,
  // is_a_slot_assigment && is_a_redefinition &arguments:
  var_std__and, 2, var_783_1_is_a_slot_assigment, lambda_84, 1, LOCAL(1),
  // update_if is_a_slot_assigment && is_a_redefinition &arguments:
  var_update_if, 3, LOCAL(1), var_784_1_arguments, lambda_85, 1, var_784_1_arguments,
  // is_a_slot_assigment && is_a_redefinition
  var_std__and, 2, var_783_1_is_a_slot_assigment, lambda_86, 1, LOCAL(1),
  // !head
  var_if, 3, LOCAL(1), lambda_87, lambda_88, 1, var_780_1_head,
...
static TAB_NUM t_lambda_82[] = {
  ...
  var_not, 1, var_783_1_is_a_slot_assigment, 1, LOCAL(1),
  // not(is_a_slot_assigment):
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(797, 19),
  POS(797, 19)
...
static TAB_NUM t_lambda_83[] = {
  ...
  0, // parameters
  // arguments(2)
  var_784_1_arguments, 1, num_2, 1, LOCAL(1),
...
static TAB_NUM t_lambda_85[] = {
  ...
  var_put, 2, var_784_1_arguments, LOCAL(3), TAIL_CALL,
  POS(802, 59),
  POS(802, 23),
  POS(802, 44),
  POS(802, 9)
...
static TAB_NUM t_func_simplify_head_and_arguments[] = {
  1, // locals
  1, // parameters
  var_810_31_is_an_assignment,
  // simplify &head &temp_no $result_statements
  var_simplify, 2, var_780_1_head, var_779_40_temp_no, 3, var_780_1_head, var_779_40_temp_no, var_811_25_result_statements,
  // $new_arguments empty_list
  LET, 1, var_empty_list, 1, var_812_1_new_arguments,
  // for_each arguments !arguments !temp_no !result_statements
  var_for_each, 3, var_784_1_arguments, lambda_89, lambda_92, 3, var_784_1_arguments, var_779_40_temp_no, var_811_25_result_statements,
  // self.head_of head
  LET, -1, var_779_35_self, var_head_of, var_780_1_head, var_779_35_self,
  // self.arguments_of arguments
  LET, -1, var_779_35_self, var_arguments_of, var_784_1_arguments, var_779_35_self,
  // is_a_slot_assigment && is_a_redefinition
  var_std__and, 2, var_783_1_is_a_slot_assigment, lambda_93, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_89[] = {
  ...
  var_simplify, 2, var_814_3_item, var_779_40_temp_no, 3, var_814_3_item, var_779_40_temp_no, LOCAL(3),
  // append &result_statements arguments_result_statements
  var_append, 2, var_811_25_result_statements, LOCAL(3), 1, var_811_25_result_statements,
  // node_type_of(item) == BACKQUOTED:
  var_node_type_of, 1, var_814_3_item, 1, LOCAL(1),
  // node_type_of(item) == BACKQUOTED:
...
static TAB_NUM t_lambda_90[] = {
  ...
  func_resolve_backquoted, 2, var_812_1_new_arguments, var_814_3_item, 1, var_812_1_new_arguments,
  // next
  var_next, 0, TAIL_CALL,
  POS(819, 13),
  POS(820, 13)
...
static TAB_NUM t_lambda_91[] = {
  ...
  var_push, 2, var_812_1_new_arguments, var_814_3_item, 1, var_812_1_new_arguments,
  // next
  var_next, 0, TAIL_CALL,
  POS(822, 13),
  POS(823, 13)
...
static TAB_NUM t_lambda_92[] = {
  ...
  LET, 3, var_812_1_new_arguments, var_779_40_temp_no, var_811_25_result_statements, TAIL_CALL,
  POS(824, 9)
};
...
static TAB_NUM t_lambda_94[] = {
  ...
  0, // parameters
  //  self temp_no result_statements
  LET, 3, var_779_35_self, var_779_40_temp_no, var_811_25_result_statements, TAIL_CALL,
  POS(829, 9)
};
...
static TAB_NUM t_lambda_95[] = {
  ...
  0, // parameters
  // if
  var_if, 3, var_810_31_is_an_assignment, lambda_is_an_assignment, lambda_107, TAIL_CALL,
  POS(831, 9)
};
...
static TAB_NUM t_lambda_is_an_assignment[] = {
  ...
  var_811_25_result_statements, 0, 2, var_833_19_leading_statements, var_833_39_trailing_statements,
  // $is_a_slot_definition
  var_std__and, 2, var_783_1_is_a_slot_assigment, lambda_96, 1, var_834_1_is_a_slot_definition,
  // self.is_a_definition is_a_slot_definition
  LET, -1, var_779_35_self, var_is_a_definition, var_834_1_is_a_slot_definition, var_779_35_self,
  // is_empty
  var_is_empty, 1, var_833_19_leading_statements, 1, LOCAL(1),
  // if
  var_if, 3, LOCAL(1), func_check_trailing_statements, lambda_97, TAIL_CALL,
  POS(833, 13),
  POS(834, 13),
  POS(836, 14),
  POS(838, 34),
...
static TAB_NUM t_lambda_97[] = {
  ...
  var_833_19_leading_statements, 1, minus_num_1, 1, var_841_1_last_statement,
  // if
  var_if, 3, var_834_1_is_a_slot_definition, lambda_is_a_slot_definition, lambda_98, TAIL_CALL,
  POS(841, 17),
  POS(842, 17)
};
...
static TAB_NUM t_lambda_is_a_slot_definition[] = {
  ...
  // arguments_of(-1)
  var_arguments_of, 1, var_841_1_last_statement, 1, LOCAL(3),
  // arguments_of(-1)
  LOCAL(3), 2, minus_num_1, LOCAL(2), 1, LOCAL(3),
  // last_statement.arguments_of(-1)
  LET, -1, var_841_1_last_statement, var_arguments_of, LOCAL(3), var_841_1_last_statement,
  // leading_statements(-1) last_statement
  var_833_19_leading_statements, 2, minus_num_1, var_841_1_last_statement, 1, var_833_19_leading_statements,
  // arguments(1).argument_of.identifier_of const_name
  var_784_1_arguments, 1, num_1, 1, LOCAL(2),
  ...
  // arguments(1).argument_of.identifier_of const_name
  var_784_1_arguments, 2, num_1, LOCAL(2), 1, var_784_1_arguments,
...
static TAB_NUM t_lambda_98[] = {
  ...
  // arguments(2))
  var_784_1_arguments, 1, num_2, 1, LOCAL(3),
  // arguments_of(last_statement)(-1 arguments(2))
  var_arguments_of, 1, var_841_1_last_statement, 1, LOCAL(4),
  // arguments_of(last_statement)(-1 arguments(2))
  LOCAL(4), 2, minus_num_1, LOCAL(3), 1, LOCAL(5),
  // !self
  LET, -3, var_841_1_last_statement, var_source_group_of, LOCAL(1), var_source_position_of, LOCAL(2), var_arguments_of, LOCAL(5), var_779_35_self,
  // range &leading_statements 1 -2
  var_range, 3, var_833_19_leading_statements, num_1, minus_num_2, 1, var_833_19_leading_statements,
  // check_trailing_statements
  func_check_trailing_statements, 0, TAIL_CALL,
  POS(858, 42),
  POS(859, 45),
...
static TAB_NUM t_func_check_trailing_statements[] = {
  ...
  0, // parameters
  // is_empty
  var_is_empty, 1, var_833_39_trailing_statements, 1, LOCAL(1),
  // 
  var_std__or, 2, LOCAL(1), lambda_99, 1, LOCAL(2),
  // if
  var_if, 3, LOCAL(2), lambda_100, func_process_trailing_statements, TAIL_CALL,
  POS(867, 39),
  POS(866, 19),
  POS(865, 15)
};
...
static TAB_NUM t_lambda_100[] = {
  ...
  0, // parameters
  // new
  var_new, 3, var_funky_types__statement_list, var_833_19_leading_statements, var_833_39_trailing_statements, 1, LOCAL(1),
  // 
...
static TAB_NUM t_func_process_trailing_statements[] = {
  ...
  var_identifier_of, 1, LOCAL(1), 1, var_885_1_temp_name,
  // $value arguments(1)
  var_784_1_arguments, 1, num_1, 1, var_886_1_value,
  // for_each trailing_statements
  var_for_each, 3, var_833_39_trailing_statements, lambda_101, lambda_105, TAIL_CALL,
  POS(885, 40),
  POS(885, 15),
  POS(886, 15),
  POS(887, 15)
...
static TAB_NUM t_lambda_101[] = {
  ...
  2, // parameters
  var_888_3_stmt_idx,
  var_888_12_trailing_statement,
  // arguments_of(trailing_statement)
  var_arguments_of, 1, var_888_12_trailing_statement, 1, LOCAL(1),
  // for_each arguments_of(trailing_statement)
  var_for_each, 3, LOCAL(1), lambda_102, var_next, TAIL_CALL,
  POS(889, 28),
  POS(889, 19)
};
...
static TAB_NUM t_lambda_102[] = {
  ...
  var_node_type_of, 1, var_890_11_argument, 1, LOCAL(1),
...
static TAB_NUM t_lambda_2_FUNCTOR[] = {
  ...
  var_identifier_of, 1, var_890_11_argument, 1, LOCAL(1),
  // identifier_of(argument) == temp_name:
  var_std__equal, 2, LOCAL(1), var_885_1_temp_name, 1, LOCAL(2),
  // if
  var_if, 3, LOCAL(2), lambda_103, var_next, TAIL_CALL,
  POS(894, 29),
  POS(894, 29),
  POS(893, 27)
};
...
static TAB_NUM t_lambda_103[] = {
  ...
  var_arguments_of, 1, var_888_12_trailing_statement, 1, LOCAL(2),
  // arguments_of(arg_idx) value
  LOCAL(2), 2, var_890_3_arg_idx, var_886_1_value, 1, LOCAL(2),
  // trailing_statement.arguments_of(arg_idx) value
  LET, -1, var_888_12_trailing_statement, var_arguments_of, LOCAL(2), var_888_12_trailing_statement,
  // trailing_statements(stmt_idx) trailing_statement
  var_833_39_trailing_statements, 2, var_888_3_stmt_idx, var_888_12_trailing_statement, 1, var_833_39_trailing_statements,
  // return
  lambda_106, 0, TAIL_CALL,
  POS(895, 51),
  POS(895, 51),
  POS(895, 32),
  POS(896, 32),
...
static TAB_NUM t_lambda_INLINE_ATTRIBUTE_VALUE_PAIR[] = {
  ...
  var_expression_of, 1, var_890_11_argument, 1, LOCAL(1),
  // identifier_of(expression_of(argument)) == temp_name:
  var_identifier_of, 1, LOCAL(1), 1, LOCAL(2),
  // identifier_of(expression_of(argument)) == temp_name:
  var_std__equal, 2, LOCAL(2), var_885_1_temp_name, 1, LOCAL(3),
  // if
  var_if, 3, LOCAL(3), lambda_104, var_next, TAIL_CALL,
  POS(901, 43),
  POS(901, 29),
  POS(901, 29),
  POS(900, 27)
...
static TAB_NUM t_lambda_104[] = {
  ...
  LET, -1, var_890_11_argument, var_expression_of, var_886_1_value, LOCAL(2),
  // arguments_of(arg_idx)
  var_arguments_of, 1, var_888_12_trailing_statement, 1, LOCAL(3),
  // arguments_of(arg_idx)
  LOCAL(3), 2, var_890_3_arg_idx, LOCAL(2), 1, LOCAL(3),
  // trailing_statement.arguments_of(arg_idx)
  LET, -1, var_888_12_trailing_statement, var_arguments_of, LOCAL(3), var_888_12_trailing_statement,
  // trailing_statements(stmt_idx) trailing_statement
  var_833_39_trailing_statements, 2, var_888_3_stmt_idx, var_888_12_trailing_statement, 1, var_833_39_trailing_statements,
  // return
  lambda_106, 0, TAIL_CALL,
...
static TAB_NUM t_lambda_106[] = {
  ...
  var_833_39_trailing_statements, 1, num_1, 1, LOCAL(1),
  // range(trailing_statements 2 -1)
  var_range, 3, var_833_39_trailing_statements, num_2, minus_num_1, 1, LOCAL(2),
  // new
  var_new, 3, var_funky_types__statement_list, var_833_19_leading_statements, LOCAL(2), 1, LOCAL(3),
  // 
...
static TAB_NUM t_lambda_107[] = {
  ...
  // !self.is_an_io_call
  var_std__or, 2, LOCAL(2), lambda_108, 1, LOCAL(4),
  // self.is_an_io_call
  LET, -1, var_779_35_self, var_is_an_io_call, LOCAL(4), var_779_35_self,
  // -> self temp_no result_statements
  LET, 3, var_779_35_self, var_779_40_temp_no, var_811_25_result_statements, TAIL_CALL,
  POS(925, 17),
  POS(925, 31),
...
static TAB_NUM t_func_check_that_all_arguments_are_inputs[] = {
  ...
  var_find_first, 2, var_784_1_arguments, var_is_an_output, 1, var_930_1_argument,
  // is_defined:
  var_is_defined, 1, var_930_1_argument, 1, LOCAL(1),
  // on argument.is_defined:
  var_on, 2, LOCAL(1), lambda_109, TAIL_CALL,
  POS(930, 5),
  POS(931, 17),
  POS(931, 5)
};
...
static TAB_NUM t_lambda_109[] = {
  ...
  var_syntax_error, 2, str_Unexpected_outpu, var_930_1_argument, TAIL_CALL,
  POS(932, 7)
};
...
static TAB_NUM t_func_is_a_pair_or_type_function[] = {
  ...
  var_node_type_of, 1, LOCAL(3), 1, var_935_1_node_type,
  // node_type == ATTRIBUTE_VALUE_PAIR
  var_std__equal, 2, var_935_1_node_type, var_ATTRIBUTE_VALUE_PAIR, 1, LOCAL(1),
  // 
...
static TAB_NUM t_lambda_110[] = {
  ...
  var_std__equal, 2, var_935_1_node_type, var_METHOD_VALUE_PAIR, 1, LOCAL(1),
  // 
  var_std__or, 2, LOCAL(1), lambda_111, 1, LOCAL(2),
  // node_type == METHOD_VALUE_PAIR
  LET, 1, LOCAL(2), TAIL_CALL,
  POS(939, 7),
  POS(937, 7),
...
static TAB_NUM t_lambda_111[] = {
  ...
  var_std__equal, 2, var_935_1_node_type, var_TYPE_FUNCTION, 1, LOCAL(1),
  // node_type == TYPE_FUNCTION
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(940, 7),
  POS(940, 7)
...
static TAB_NUM t_func_funky_types__numeric_literal___simplify[] = {
  ...
  // replace_all &digits
  var_replace_all, 3, LOCAL(5), key_value_pair_947_1, key_value_pair_948_1, 1, LOCAL(5),
  // "num_@(digits)")
...
static TAB_NUM t_func_funky_types__named_character_literal___simplify[] = {
  ...
  var_971_54_temp_no,
  // funky::name_of(self))
  var_funky__name_of, 1, var_971_49_self, 1, LOCAL(1),
  // $chr character_from_name(funky::name_of(self))
  var_character_from_name, 1, LOCAL(1), 1, var_972_1_chr,
  // is_defined
  var_is_defined, 1, var_972_1_chr, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_112[] = {
  ...
  var_to_integer, 1, var_972_1_chr, 1, LOCAL(1),
  // to_string self)
  var_to_string, 1, LOCAL(1), 1, LOCAL(2),
  // create_numeric_character_literal(chr.to_integer.to_string self)
  func_create_numeric_character_literal, 2, LOCAL(2), var_971_49_self, 1, LOCAL(3),
  // 
  LET, 3, LOCAL(3), var_971_54_temp_no, var_empty_statements, TAIL_CALL,
  POS(976, 44),
  POS(976, 55),
  POS(976, 7),
  POS(975, 7)
...
static TAB_NUM t_lambda_113[] = {
  ...
  var_syntax_error, 2, str_Invalid_characte, var_971_49_self, TAIL_CALL,
  POS(980, 7)
};
...
static TAB_NUM t_func_create_numeric_character_literal[] = {
  6, // locals
  2, // parameters
  LOCAL(5), // 988_36_digits
  LOCAL(6), // 988_43_original_node
  // "chr_@(digits)"
  var_std__string, 2, str_chr, LOCAL(5), 1, LOCAL(1),
...
static TAB_NUM t_func_funky_types__string_literal___simplify[] = {
  ...
  LET, 1, var_empty_list, 1, var_1007_1_arguments,
  // $characters ""
  LET, 1, string_4, 1, var_1008_1_characters,
  // $statements empty_statements
  LET, 1, var_empty_statements, 1, var_1009_1_statements,
  // $components components_of(self)
  var_components_of, 1, var_1006_40_self, 1, var_1010_1_components,
  // is_empty
  var_is_empty, 1, var_1010_1_components, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_114[] = {
  ...
  0, // parameters
  // source_group_of(self)
  var_source_group_of, 1, var_1006_40_self, 1, LOCAL(1),
  // source_position_of(self)
  var_source_position_of, 1, var_1006_40_self, 1, LOCAL(2),
  ...
  // 
  LET, 3, LOCAL(3), var_1006_45_temp_no, var_empty_statements, TAIL_CALL,
  POS(1017, 26),
  POS(1018, 29),
  POS(1014, 7),
  POS(1013, 7)
...
static TAB_NUM t_lambda_115[] = {
  ...
  0, // parameters
  // for_each components
  var_for_each, 3, var_1010_1_components, lambda_116, lambda_122, TAIL_CALL,
  POS(1022, 7)
};
...
static TAB_NUM t_lambda_116[] = {
  ...
  2, // parameters
  var_1023_3_idx,
  var_1023_7_component,
  // node_type_of(component)
  var_node_type_of, 1, var_1023_7_component, 1, LOCAL(1),
  // case node_type_of(component)
  var_case, 16, LOCAL(1), var_CHARACTER_SEQUENCE, lambda_CHARACTER_SEQUENCE, var_NUMERIC_CHARACTER, lambda_NUMERIC_CHARACTER, var_NAMED_CHARACTER, lambda_NAMED_CHARACTER, var_NEWLINE, lambda_NEWLINE, var_AT_CHARACTER, lambda_AT_CHARACTER, var_ESCAPE_EXPRESSION, lambda_ESCAPE_EXPRESSION, var_TAGGED_EMPTY_CHARACTER, lambda_TAGGED_EMPTY_CHARACTER, lambda_121, TAIL_CALL,
  POS(1024, 16),
  POS(1024, 11)
};
...
static TAB_NUM t_lambda_CHARACTER_SEQUENCE[] = {
  ...
  var_characters_of, 1, var_1023_7_component, 1, var_1026_1_component_characters,
  // 1
  var_std__less, 2, num_1, var_1023_3_idx, 1, LOCAL(1),
  // 
  var_std__and, 2, LOCAL(1), lambda_117, 1, LOCAL(2),
  // if # suppress leading whitespace after line ending with '@'
  var_if, 3, LOCAL(2), lambda_118, lambda_119, 1, LOCAL(3),
  // append &characters
  var_append, 2, var_1008_1_characters, LOCAL(3), 1, var_1008_1_characters,
  // next
  var_next, 0, TAIL_CALL,
  POS(1026, 15),
  POS(1030, 27),
...
static TAB_NUM t_lambda_117[] = {
  ...
  var_std__minus, 2, var_1023_3_idx, num_1, 1, LOCAL(1),
  // components(idx-1)) == CHARACTER_SEQUENCE
  var_1010_1_components, 1, LOCAL(1), 1, LOCAL(2),
...
static TAB_NUM t_lambda_118[] = {
  ...
  var_trim_left, 1, var_1026_1_component_characters, 1, LOCAL(1),
  //  trim_left(component_characters)
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(1032, 22),
  POS(1032, 21)
...
static TAB_NUM t_lambda_119[] = {
  ...
  LET, 1, var_1026_1_component_characters, TAIL_CALL,
  POS(1033, 21)
};
...
static TAB_NUM t_lambda_NUMERIC_CHARACTER[] = {
  ...
  var_digits_of, 1, var_1023_7_component, 1, LOCAL(1),
  // to_integer)
  var_to_integer, 1, LOCAL(1), 1, LOCAL(2),
  ...
  var_push, 2, var_1008_1_characters, LOCAL(3), 1, var_1008_1_characters,
  // next
  var_next, 0, TAIL_CALL,
  POS(1036, 42),
  POS(1036, 63),
...
static TAB_NUM t_lambda_NAMED_CHARACTER[] = {
  ...
  var_funky__name_of, 1, var_1023_7_component, 1, LOCAL(1),
  ...
  var_on, 2, LOCAL(1), lambda_120, 0,
  // push &characters character
  var_push, 2, var_1008_1_characters, LOCAL(2), 1, var_1008_1_characters,
  // next
  var_next, 0, TAIL_CALL,
  POS(1039, 46),
  POS(1039, 15),
...
static TAB_NUM t_lambda_120[] = {
  ...
  var_syntax_error, 2, str_Invalid_characte, var_1023_7_component, TAIL_CALL,
  POS(1041, 17)
};
...
static TAB_NUM t_lambda_NEWLINE[] = {
  ...
  0, // parameters
  // push &characters '@nl;'
  var_push, 2, var_1008_1_characters, chr_10, 1, var_1008_1_characters,
  // next
  var_next, 0, TAIL_CALL,
  POS(1045, 15),
  POS(1046, 15)
...
static TAB_NUM t_lambda_AT_CHARACTER[] = {
  ...
  0, // parameters
  // push &characters '@@'
  var_push, 2, var_1008_1_characters, chr_64, 1, var_1008_1_characters,
  // next
  var_next, 0, TAIL_CALL,
  POS(1048, 15),
  POS(1049, 15)
...
static TAB_NUM t_lambda_ESCAPE_EXPRESSION[] = {
  ...
  var_expression_of, 1, var_1023_7_component, 1, LOCAL(1),
  // simplify expression_of(component)
  var_simplify, 2, LOCAL(1), var_1006_45_temp_no, 3, LOCAL(2), var_1006_45_temp_no, LOCAL(3),
  // append &statements escape_statements
  var_append, 2, var_1009_1_statements, LOCAL(3), 1, var_1009_1_statements,
  // add_characters !arguments !characters
  func_add_characters, 0, 2, var_1007_1_arguments, var_1008_1_characters,
  // push &arguments expression
  var_push, 2, var_1007_1_arguments, LOCAL(2), 1, var_1007_1_arguments,
  // next
  var_next, 0, TAIL_CALL,
  POS(1051, 24),
  POS(1051, 15),
...
static TAB_NUM t_lambda_122[] = {
  ...
  var_length_of, 1, var_1007_1_arguments, 1, LOCAL(1),
  // length_of(arguments) == 1
  var_std__equal, 2, LOCAL(1), num_1, 1, LOCAL(2),
  // 
  var_std__and, 2, LOCAL(2), lambda_123, 1, LOCAL(3),
  // if
  var_if, 3, LOCAL(3), lambda_124, lambda_125, TAIL_CALL,
  POS(1063, 11),
  POS(1066, 15),
  POS(1066, 15),
  POS(1065, 15),
...
static TAB_NUM t_lambda_123[] = {
  ...
  var_1007_1_arguments, 1, num_1, 1, LOCAL(1),
...
static TAB_NUM t_lambda_124[] = {
  ...
  var_1007_1_arguments, 1, num_1, 1, LOCAL(1),
  //  arguments(1) temp_no empty_statements
  LET, 3, LOCAL(1), var_1006_45_temp_no, var_empty_statements, TAIL_CALL,
  POS(1068, 16),
  POS(1068, 15)
};
...
static TAB_NUM t_lambda_125[] = {
  ...
  func_temporary, 2, var_1006_45_temp_no, var_1006_40_self, 1, LOCAL(1),
  // redefine_temporary(temp_no functor))
  func_redefine_temporary, 2, var_1006_45_temp_no, LOCAL(8), 1, LOCAL(2),
  // push(arguments redefine_temporary(temp_no functor))
  var_push, 2, var_1007_1_arguments, LOCAL(2), 1, LOCAL(3),
  // create_statement
  func_create_statement, 2, LOCAL(8), LOCAL(3), 1, LOCAL(4),
  // push_leading_statement
  var_push_leading_statement, 2, var_1009_1_statements, LOCAL(4), 1, LOCAL(5),
  // ->
  LET, 3, LOCAL(1), var_1006_45_temp_no, LOCAL(5), TAIL_CALL,
  POS(1070, 15),
  POS(1071, 34),
  POS(1071, 15),
  POS(1072, 15),
...
static TAB_NUM t_func_add_characters[] = {
  ...
  0, // parameters
  // is_empty
  var_is_empty, 1, var_1008_1_characters, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_126[] = {
  ...
  LET, 2, var_1007_1_arguments, var_1008_1_characters, TAIL_CALL,
  POS(1092, 13)
};
...
static TAB_NUM t_lambda_127[] = {
  ...
  var_length_of, 1, var_1008_1_characters, 1, LOCAL(3),
  // "string@(length_of(characters))_@(characters)"
  var_std__string, 4, str_string_2, LOCAL(3), string_2, var_1008_1_characters, 1, LOCAL(4),
  // funky_types::character_sequence
  LET, -4, var_funky_types__character_sequence, var_source_group_of, LOCAL(1), var_source_position_of, LOCAL(2), var_characters_of, var_1008_1_characters, var_funky__key_of, LOCAL(4), LOCAL(5),
  // push
  var_push, 2, var_1007_1_arguments, LOCAL(5), 1, LOCAL(6),
  // 
...
static TAB_NUM t_func_std_types__list___simplify[] = {
  1, // locals
  2, // parameters
  LOCAL(1), // 1103_28_self
  var_1103_33_temp_no,
  // $statements empty_statements
  LET, 1, var_empty_statements, 1, var_1104_1_statements,
  // $simplified_nodes empty_list
  LET, 1, var_empty_list, 1, var_1105_1_simplified_nodes,
  // for_each self
  var_for_each, 3, LOCAL(1), lambda_128, lambda_129, TAIL_CALL,
  POS(1104, 3),
  POS(1105, 3),
  POS(1106, 3)
};
...
static TAB_NUM t_lambda_128[] = {
  ...
  var_simplify, 2, LOCAL(1), var_1103_33_temp_no, 3, LOCAL(1), var_1103_33_temp_no, LOCAL(2),
  // append &statements node_statements
  var_append, 2, var_1104_1_statements, LOCAL(2), 1, var_1104_1_statements,
  // push &simplified_nodes node
  var_push, 2, var_1105_1_simplified_nodes, LOCAL(1), 1, var_1105_1_simplified_nodes,
  // next
  var_next, 0, TAIL_CALL,
  POS(1108, 7),
  POS(1109, 7),
...
static TAB_NUM t_lambda_129[] = {
  ...
  LET, 3, var_1105_1_simplified_nodes, var_1103_33_temp_no, var_1104_1_statements, TAIL_CALL,
  POS(1112, 7)
};
...
static TAB_NUM t_func_create_statement[] = {
  ...
  2, // parameters
  var_1170_20_head,
  var_1170_25_arguments,
  // is_not_empty:
  var_is_not_empty, 1, var_1170_25_arguments, 1, LOCAL(1),
  // if
  var_if, 3, LOCAL(1), lambda_arguments_is_not_empty, lambda_133, TAIL_CALL,
  POS(1172, 15),
  POS(1171, 3)
};
...
static TAB_NUM t_lambda_arguments_is_not_empty[] = {
  ...
  0, // parameters
  // arguments(1))
  var_1170_25_arguments, 1, num_1, 1, LOCAL(1),
  // $node_type node_type_of(arguments(1))
  var_node_type_of, 1, LOCAL(1), 1, var_1173_1_node_type,
  // node_type == ATTRIBUTE_VALUE_PAIR
  var_std__equal, 2, var_1173_1_node_type, var_ATTRIBUTE_VALUE_PAIR, 1, LOCAL(1),
  // 
...
static TAB_NUM t_lambda_130[] = {
  ...
  0, // parameters
  // node_type == METHOD_VALUE_PAIR
  var_std__equal, 2, var_1173_1_node_type, var_METHOD_VALUE_PAIR, 1, LOCAL(1),
  // 
...
static TAB_NUM t_lambda_131[] = {
  ...
  0, // parameters
  // node_type == TYPE_FUNCTION
  var_std__equal, 2, var_1173_1_node_type, var_TYPE_FUNCTION, 1, LOCAL(1),
  // node_type == TYPE_FUNCTION
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(1178, 11),
  POS(1178, 11)
...
static TAB_NUM t_lambda_132[] = {
  ...
  func_assign_attributes, 1, var_1170_20_head, 1, LOCAL(1),
  // put(arguments head)
  var_put, 2, var_1170_25_arguments, var_1170_20_head, 1, LOCAL(2),
  // source_group_of(head)
  var_source_group_of, 1, var_1170_20_head, 1, LOCAL(3),
  // source_position_of(head)
  var_source_position_of, 1, var_1170_20_head, 1, LOCAL(4),
  // funky_types::statement
...
static TAB_NUM t_lambda_133[] = {
  ...
  func_expand_backquotes, 1, var_1170_25_arguments, 1, LOCAL(1),
  // source_group_of(head)
  var_source_group_of, 1, var_1170_20_head, 1, LOCAL(2),
  // source_position_of(head)
  var_source_position_of, 1, var_1170_20_head, 1, LOCAL(3),
  // funky_types::statement
  LET, -4, var_funky_types__statement, var_head_of, var_1170_20_head, var_arguments_of, LOCAL(1), var_source_group_of, LOCAL(2), var_source_position_of, LOCAL(3), LOCAL(4),
  // 
  LET, 1, LOCAL(4), TAIL_CALL,
  POS(1192, 23),
  POS(1193, 26),
...
static TAB_NUM t_func_expand_backquotes[] = {
  1, // locals
  1, // parameters
  LOCAL(1), // 1196_21_arguments
  // $expanded empty_list
  LET, 1, var_empty_list, 1, var_1197_1_expanded,
  // for_each arguments
  var_for_each, 3, LOCAL(1), lambda_134, lambda_137, TAIL_CALL,
  POS(1197, 3),
  POS(1198, 3)
};
...
static TAB_NUM t_lambda_134[] = {
  ...
  var_node_type_of, 1, var_1199_3_argument, 1, LOCAL(1),
  // node_type_of(argument) == BACKQUOTED:
  var_std__equal, 2, LOCAL(1), var_BACKQUOTED, 1, LOCAL(2),
  // if
...
static TAB_NUM t_lambda_135[] = {
  ...
  func_resolve_backquoted, 2, var_1197_1_expanded, var_1199_3_argument, 1, var_1197_1_expanded,
  // next
  var_next, 0, TAIL_CALL,
  POS(1202, 11),
  POS(1203, 11)
...
static TAB_NUM t_lambda_136[] = {
  ...
  var_push, 2, var_1197_1_expanded, var_1199_3_argument, 1, var_1197_1_expanded,
  // next
  var_next, 0, TAIL_CALL,
  POS(1205, 11),
  POS(1206, 11)
...
static TAB_NUM t_lambda_137[] = {
  ...
  0, // parameters
  //  expanded
  LET, 1, var_1197_1_expanded, TAIL_CALL,
  POS(1207, 7)
};
...
static TAB_NUM t_func_resolve_backquoted[] = {
  8, // locals
  2, // parameters
  LOCAL(6), // 1209_22_arguments
  LOCAL(7), // 1209_32_node
...
static TAB_NUM t_func_exctract_characters[] = {
  ...
  var_1219_23_str,
  // $level 0
  LET, 1, num_0, 1, var_1220_1_level,
  // $within_string false
  LET, 1, var_false, 1, var_1221_1_within_string,
  // for_each str: (idx chr)
  var_for_each, 2, var_1219_23_str, lambda_138, TAIL_CALL,
  POS(1220, 5),
  POS(1221, 5),
  POS(1222, 5)
};
...
static TAB_NUM t_lambda_138[] = {
  ...
  LOCAL(1), // 1222_19_chr
  // case chr
  var_case, 12, LOCAL(1), chr_10, lambda_nl, chr_32, lambda_139, chr_34, lambda_quot, chr_40, lambda_142, chr_41, lambda_143, var_next, TAIL_CALL,
  POS(1223, 7)
};
...
static TAB_NUM t_lambda_nl[] = {
  ...
  0, // parameters
  // range(str 1 -2)
  var_range, 3, var_1219_23_str, num_1, minus_num_2, 1, LOCAL(1),
  //  range(str 1 -2)
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(1224, 19),
  POS(1224, 18)
...
static TAB_NUM t_lambda_139[] = {
  ...
  var_std__equal, 2, var_1220_1_level, num_0, 1, LOCAL(1),
  // level == 0 && not(within_string)
  var_std__and, 2, LOCAL(1), lambda_140, 1, LOCAL(2),
  // if
  var_if, 3, LOCAL(2), lambda_141, var_next, TAIL_CALL,
  POS(1227, 13),
  POS(1227, 13),
  POS(1226, 11)
};
...
static TAB_NUM t_lambda_140[] = {
  ...
  0, // parameters
  // not(within_string)
  var_not, 1, var_1221_1_within_string, 1, LOCAL(1),
  // not(within_string)
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(1227, 27),
  POS(1227, 27)
...
static TAB_NUM t_lambda_141[] = {
  ...
  0, // parameters
  // idx-1)
  var_std__minus, 2, var_1222_15_idx, num_1, 1, LOCAL(1),
  // range(str 1 idx-1)
  var_range, 3, var_1219_23_str, num_1, LOCAL(1), 1, LOCAL(2),
  //  range(str 1 idx-1)
  LET, 1, LOCAL(2), TAIL_CALL,
  POS(1228, 28),
  POS(1228, 16),
...
static TAB_NUM t_lambda_quot[] = {
  ...
  0, // parameters
  // not &within_string
  var_not, 1, var_1221_1_within_string, 1, var_1221_1_within_string,
  // next
  var_next, 0, TAIL_CALL,
  POS(1231, 11),
  POS(1232, 11)
...
static TAB_NUM t_lambda_142[] = {
  ...
  0, // parameters
  // inc &level
  var_inc, 1, var_1220_1_level, 1, var_1220_1_level,
  // next
  var_next, 0, TAIL_CALL,
  POS(1234, 11),
  POS(1235, 11)
...
static TAB_NUM t_lambda_143[] = {
  ...
  0, // parameters
  // dec &level
  var_dec, 1, var_1220_1_level, 1, var_1220_1_level,
  // next
  var_next, 0, TAIL_CALL,
  POS(1237, 11),
  POS(1238, 11)
...
static TAB_NUM t_func_funky_types__statement_list___append[] = {
  6, // locals
  2, // parameters
  LOCAL(1), // 1241_38_self
  LOCAL(2), // 1241_43_right
...
static TAB_NUM t_func_funky_types__statement_list___push_leading_statement[] = {
  4, // locals
  2, // parameters
  LOCAL(1), // 1248_54_self
  LOCAL(2), // 1248_59_statement
  // self $leading_statements $trailing_statements
  LOCAL(1), 0, 2, LOCAL(3), LOCAL(4),
...
static TAB_NUM t_func_funky_types__statement_list___push_trailing_statement[] = {
  4, // locals
  2, // parameters
  LOCAL(1), // 1253_55_self
  LOCAL(2), // 1253_60_statement
  // self $leading_statements $trailing_statements
  LOCAL(1), 0, 2, LOCAL(3), LOCAL(4),
...
static TAB_NUM t_func_collect_parameter_definitions[] = {
  ...
  var_for_each, 3, LOCAL(1), var_add_definition, lambda_144, TAIL_CALL,
  POS(1261, 12),
  POS(1261, 3)
};
...
static TAB_NUM t_func_collect_local_definitions[] = {
  1, // locals
  1, // parameters
  LOCAL(1), // 1263_29_statements
  // for_each statements add_definitions -> resolve_variable
  var_for_each, 3, LOCAL(1), var_add_definitions, lambda_145, TAIL_CALL,
  POS(1264, 3)
};
...
static TAB_NUM t_func_funky_types__definition___add_definition[] = {
  ...
  var_identifier_of, 1, var_1281_42_self, 1, var_1282_1_identifier,
  ...
  var_on, 2, LOCAL(2), lambda_147, 0,
  // !resolve_variable(identifier) mangle_local_definition(identifier self)
  var_mangle_local_definition, 2, var_1282_1_identifier, var_1281_42_self, 1, LOCAL(2),
  // resolve_variable(identifier) mangle_local_definition(identifier self)
  var_resolve_variable, 2, var_1282_1_identifier, LOCAL(2), 1, var_resolve_variable,
  // next
  var_next, 0, TAIL_CALL,
  POS(1282, 3),
  POS(1283, 6),
...
static TAB_NUM t_lambda_146[] = {
  ...
  var_resolve_variable, 1, var_1282_1_identifier, 1, LOCAL(1),
  // is_defined:
  var_is_defined, 1, LOCAL(1), 1, LOCAL(2),
  // resolve_variable(identifier).is_defined:
  LET, 1, LOCAL(2), TAIL_CALL,
...
static TAB_NUM t_lambda_147[] = {
  ...
  var_syntax_error, 2, str_Variable_is_alre, var_1281_42_self, TAIL_CALL,
  POS(1284, 5)
};
...
static TAB_NUM t_func_funky__mangle_local_definition[] = {
  4, // locals
  2, // parameters
  LOCAL(3), // 1296_34_identifier
  LOCAL(4), // 1296_45_definition
...
static int key_value_pair_947_1_arguments[] = {
  -chr_46, -string_2
};

static int key_value_pair_948_1_arguments[] = {
  -chr_45, -string_2
};
...
static FUNKY_CONSTANT constants_table[] = {
  ...
  {FLT_KEY_VALUE_PAIR, 2, {.arguments = key_value_pair_947_1_arguments}},
  {FLT_KEY_VALUE_PAIR, 2, {.arguments = key_value_pair_948_1_arguments}},
...
static FUNKY_VARIABLE variables_table[] = {
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "783_1_is_a_slot_assigment\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "784_1_arguments\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "FUNCTOR\000", NULL,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "810_31_is_an_assignment\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "811_25_result_statements\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "812_1_new_arguments\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "814_3_item\000", NULL
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "833_19_leading_statements\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "833_39_trailing_statements\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "834_1_is_a_slot_definition\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "841_1_last_statement\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "line_no_of\000", NULL,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "885_1_temp_name\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "886_1_value\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "888_3_stmt_idx\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "888_12_trailing_statement\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "890_3_arg_idx\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "890_11_argument\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "971_49_self\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "971_54_temp_no\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "972_1_chr\000", NULL
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "1006_40_self\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1006_45_temp_no\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1007_1_arguments\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1008_1_characters\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1009_1_statements\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1010_1_components\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "components_of\000", NULL,
    {.position = POS(1010, 15)}
  },
  {
    FOT_UNKNOWN, 0, 0,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "1023_7_component\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "CHARACTER_SEQUENCE\000", NULL,
    {.position = POS(1025, 13)}
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1026_1_component_characters\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "minus\000std", NULL,
    {.position = POS(1031, 45)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "trim_left\000", NULL,
    {.position = POS(1032, 22)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "NUMERIC_CHARACTER\000", NULL,
    {.position = POS(1035, 13)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "character\000", NULL,
    {.position = POS(1036, 32)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "NAMED_CHARACTER\000", NULL,
    {.position = POS(1038, 13)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "NEWLINE\000", NULL,
    {.position = POS(1044, 13)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "AT_CHARACTER\000", NULL,
    {.position = POS(1047, 13)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "ESCAPE_EXPRESSION\000", NULL,
    {.position = POS(1050, 13)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "TAGGED_EMPTY_CHARACTER\000", NULL,
    {.position = POS(1057, 13)}
  },
  {
    FOT_UNKNOWN, 0, 1,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "1103_33_temp_no\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1104_1_statements\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1105_1_simplified_nodes\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "TEMPORARY\000", NULL,
    {.position = POS(1146, 16)}
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1170_20_head\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1170_25_arguments\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1173_1_node_type\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1197_1_expanded\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1199_3_argument\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1219_23_str\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1220_1_level\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1221_1_within_string\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1222_15_idx\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "dec\000", NULL,
    {.position = POS(1237, 11)}
  },
  {
    FOT_POLYMORPHIC, 0, 0,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "1281_42_self\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1282_1_identifier\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "allow_hidden\000", NULL,
    {.position = POS(1283, 10)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "mangle_local_definition\000", NULL,
    {.position = POS(1285, 33)}
  },
  {
    FOT_INITIALIZED, 0, 0,
...
FUNKY_MODULE module__simplify = {
  ...
  372, // number of constants
  374, // number of variables
