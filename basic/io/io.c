...
static TAB_NUM t_lambda_31[] = {
  ...
  0, // parameters
  // close! fd
  var_close, 1, var_966_13_fd, IO_CALL(0),
  // stop_reading_from &io fd
  var_stop_reading_from, 2, var_956_1_io, var_966_13_fd, 1, var_956_1_io,
  // next!
  var_next, 0, IO_TAIL_CALL,
  POS(971, 15),
  POS(972, 15),
...
static TAB_NUM t_lambda_32[] = {
  ...
  0, // parameters
  // case fd
  var_case, 6, var_966_13_fd, var_954_29_out_fd, lambda_out_fd, var_954_37_err_fd, lambda_err_fd, lambda_35, IO_TAIL_CALL,
  POS(975, 15)
};
...
static TAB_NUM t_lambda_PROCESS_JOINED[] = {
  ...
  0, // parameters
  // $ret data
  LET, 1, var_966_17_data, 1, var_995_1_ret,
  // if
...
static TAB_NUM t_lambda_36[] = {
  ...
  0, // parameters
  //  ret out err
  LET, 3, var_995_1_ret, var_961_1_out, var_962_1_err, TAIL_CALL,
  POS(1000, 19)
};
...
static TAB_NUM t_lambda_37[] = {
  ...
  0, // parameters
  //  ret out
  LET, 2, var_995_1_ret, var_961_1_out, TAIL_CALL,
  POS(1001, 19)
};
...
static TAB_NUM t_lambda_arg_is_a_function[] = {
  ...
  var_update_if, 3, LOCAL(1), var_1113_1_commands, lambda_47, 1, var_1113_1_commands,
  // !head command_of(arg)
...
static TAB_NUM t_lambda_49[] = {
  ...
  var_is_defined, 1, var_1114_1_head, 1, LOCAL(1),
  // update_if head.is_defined &commands:
  var_update_if, 3, LOCAL(1), var_1113_1_commands, lambda_50, 1, var_1113_1_commands,
...
static TAB_NUM t_func_run_pipe[] = {
  ...
  var_is_defined, 1, var_environment, 1, LOCAL(1),
  // update_if environment.is_defined &env_vars:
  var_update_if, 3, LOCAL(1), var_1178_1_env_vars, lambda_53, 1, var_1178_1_env_vars,
  // for_each commands
  var_for_each, 3, var_1173_0_commands, lambda_56, lambda_60, IO_TAIL_CALL,
  POS(1175, 3),
  POS(1176, 3),
  POS(1177, 3),
  POS(1178, 3),
...
static TAB_NUM t_lambda_6_loop[] = {
  ...
  var_update_if, 3, LOCAL(1), var_1218_1_read_descriptor_list, lambda_64, 1, var_1218_1_read_descriptor_list,
  // pselect!
...
static TAB_NUM t_lambda_68[] = {
  ...
  var_for_each, 3, var_1229_1_write_descriptors, lambda_69, lambda_70, IO_TAIL_CALL,
  POS(1250, 15)
};
...
static TAB_NUM t_lambda_70[] = {
  ...
  var_for_each, 3, var_1228_1_read_descriptors, lambda_71, lambda_77, IO_TAIL_CALL,
  POS(1261, 19)
};
