...
enum {
  ...
  var_51_0_deserializers, // dynamic
  var_next, // extern
  var_for_each, // extern
  var_std__deserialize, // initialized
  var_64_18_lines, // dynamic
  var_split_into_lines, // extern
  var_65_13_line, // dynamic
  var_trim, // extern
  var_std__value_range, // extern
  var_69_1_buf, // dynamic
  var_range, // extern
  var_is_empty, // extern
  var_76_1_chr, // dynamic
  ...
  var_case, // extern
  var_114_1_idx, // dynamic
  var_115_1_len, // dynamic
  var_length_of, // extern
  var_std__less, // extern
  var_deserializers, // extern
  var_tuple, // extern
  var_std__plus, // extern
  var_124_1_value, // dynamic
  var_std__and, // extern
  ...
  var_map, // extern
  var_138_9_i, // dynamic
  var_139_1_items, // dynamic
  var_empty_list, // extern
  var_142_1_item, // dynamic
  var_is_defined, // extern
  var_is_a_tuple, // extern
  var_146_6_type, // dynamic
  var_146_12_argument, // dynamic
...
static TAB_NUM t_lambda_1[] = {
  ...
  // deserializers(serialization_tag_of(type)) type
  var_51_0_deserializers, 2, LOCAL(2), LOCAL(3), 1, var_51_0_deserializers,
  // next
...
static TAB_NUM t_lambda_2[] = {
  ...
  0, // parameters
  //  deserializers
  LET, 1, var_51_0_deserializers, TAIL_CALL,
  POS(58, 7)
};
...
static TAB_NUM t_func_std__deserialize[] = {
  ...
  var_split_into_lines, 1, LOCAL(2), 1, var_64_18_lines,
  // map &lines: (line)
  var_map, 2, var_64_18_lines, lambda_3, 1, var_64_18_lines,
...
static TAB_NUM t_lambda_3[] = {
  ...
  var_65_13_line,
  // trim &line
  var_trim, 1, var_65_13_line, 1, var_65_13_line,
  // line(1)
  var_65_13_line, 1, num_1, 1, LOCAL(1),
  // case line(1)
  var_case, 10, LOCAL(1), chr_34, lambda_quot, chr_39, lambda_apos, value_range_102_1, lambda_12, chr_60, lambda_15, lambda_17, TAIL_CALL,
  POS(66, 5),
  POS(67, 10),
  POS(67, 5)
};
...
static TAB_NUM t_lambda_quot[] = {
  ...
  0, // parameters
  // $buf ""
  LET, 1, string_1, 1, var_69_1_buf,
  // range &line 2 -2
  var_range, 3, var_65_13_line, num_2, minus_num_2, 1, var_65_13_line,
  // loop:
...
static TAB_NUM t_lambda_loop[] = {
  ...
  0, // parameters
  // is_empty
  var_is_empty, 1, var_65_13_line, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_5[] = {
  ...
  0, // parameters
  // $chr line(1)
  var_65_13_line, 1, num_1, 1, var_76_1_chr,
  // range &line 2 -1
  var_range, 3, var_65_13_line, num_2, minus_num_1, 1, var_65_13_line,
  // chr == '@@':
  var_std__equal, 2, var_76_1_chr, chr_64, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_6[] = {
  ...
  0, // parameters
  // $code integer(line)
  var_integer, 1, var_65_13_line, 1, LOCAL(2),
  // character(code)
  var_character, 1, LOCAL(2), 1, LOCAL(1),
  // push &buf character(code)
  var_push, 2, var_69_1_buf, LOCAL(1), 1, var_69_1_buf,
  // loop
...
static TAB_NUM t_lambda_9[] = {
  ...
  0, // parameters
  // push &buf chr
  var_push, 2, var_69_1_buf, var_76_1_chr, 1, var_69_1_buf,
  // next
  var_next, 0, TAIL_CALL,
  POS(93, 19),
  POS(94, 19)
...
static TAB_NUM t_lambda_apos[] = {
  ...
  0, // parameters
  // $chr line(2)
  var_65_13_line, 1, num_2, 1, var_96_1_chr,
  // chr == '@@':
  var_std__equal, 2, var_96_1_chr, chr_64, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_10[] = {
  ...
  0, // parameters
  // range(line 3 -1))
  var_range, 3, var_65_13_line, num_3, minus_num_1, 1, LOCAL(1),
...
static TAB_NUM t_lambda_12[] = {
  ...
  0, // parameters
  // line .contains. '.'
  var_contains, 2, var_65_13_line, chr_46, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_13[] = {
  ...
  0, // parameters
  // real(line)
  var_real, 1, var_65_13_line, 1, LOCAL(1),
  //  real(line)
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(105, 14),
  POS(105, 13)
...
static TAB_NUM t_lambda_14[] = {
  ...
  0, // parameters
  // integer(line)
  var_integer, 1, var_65_13_line, 1, LOCAL(1),
  //  integer(line)
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(106, 14),
  POS(106, 13)
...
static TAB_NUM t_lambda_15[] = {
  ...
  0, // parameters
  // case line
  var_case, 8, var_65_13_line, str_true, lambda_true, str_false, lambda_false, str_undefined, lambda_undefined, lambda_16, TAIL_CALL,
  POS(108, 9)
};
...
static TAB_NUM t_lambda_16[] = {
  ...
  0, // parameters
  // range(line 2 -2))
  var_range, 3, var_65_13_line, num_2, minus_num_2, 1, LOCAL(1),
...
static TAB_NUM t_lambda_17[] = {
  ...
  0, // parameters
  // $idx 1
  LET, 1, num_1, 1, var_114_1_idx,
  // $len length_of(line)
  var_length_of, 1, var_65_13_line, 1, var_115_1_len,
  // loop:
...
static TAB_NUM t_lambda_2_loop[] = {
  ...
  0, // parameters
  // len
  var_std__less, 2, var_115_1_len, var_114_1_idx, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_18[] = {
  ...
  0, // parameters
  // deserializers(line) "")
  var_deserializers, 1, var_65_13_line, 1, LOCAL(1),
...
static TAB_NUM t_lambda_19[] = {
  ...
  0, // parameters
  // line(idx) == ' '
  var_65_13_line, 1, var_114_1_idx, 1, LOCAL(1),
  // line(idx) == ' '
...
static TAB_NUM t_lambda_20[] = {
  ...
  0, // parameters
  // idx+1 -1)
  var_std__plus, 2, var_114_1_idx, num_1, 1, LOCAL(1),
  // $value range(line idx+1 -1)
  var_range, 3, var_65_13_line, LOCAL(1), minus_num_1, 1, var_124_1_value,
  // value(1) == '<' && value(-1) == '>' &value
  var_124_1_value, 1, num_1, 1, LOCAL(1),
  // value(1) == '<' && value(-1) == '>' &value
  var_std__equal, 2, LOCAL(1), chr_60, 1, LOCAL(2),
  // value(1) == '<' && value(-1) == '>' &value
  var_std__and, 2, LOCAL(2), lambda_21, 1, LOCAL(3),
  // update_if value(1) == '<' && value(-1) == '>' &value
  var_update_if, 3, LOCAL(3), var_124_1_value, lambda_22, 1, var_124_1_value,
  // idx-1))
  var_std__minus, 2, var_114_1_idx, num_1, 1, LOCAL(1),
  // range(line 1 idx-1))
  var_range, 3, var_65_13_line, num_1, LOCAL(1), 1, LOCAL(2),
  // deserializers(range(line 1 idx-1))
  var_deserializers, 1, LOCAL(2), 1, LOCAL(3),
  // tuple
  var_tuple, 2, LOCAL(3), var_124_1_value, 1, LOCAL(4),
  // ->
...
static TAB_NUM t_lambda_21[] = {
  ...
  0, // parameters
  // value(-1) == '>' &value
  var_124_1_value, 1, minus_num_1, 1, LOCAL(1),
  // value(-1) == '>' &value
...
static TAB_NUM t_lambda_22[] = {
  ...
  var_range, 3, var_124_1_value, num_2, minus_num_2, 1, LOCAL(1),
  // to_integer
...
static TAB_NUM t_lambda_23[] = {
  ...
  0, // parameters
  // inc &idx
  var_inc, 1, var_114_1_idx, 1, var_114_1_idx,
  // next
  var_next, 0, TAIL_CALL,
  POS(132, 19),
  POS(133, 19)
...
static TAB_NUM t_func_fetch[] = {
  ...
  LOCAL(1), // 138_11_len
  // $items empty_list
  LET, 1, var_empty_list, 1, var_139_1_items,
  // repeat len
...
static TAB_NUM t_lambda_24[] = {
  ...
  0, // parameters
  // $item lines(i)
  var_64_18_lines, 1, var_138_9_i, 1, var_142_1_item,
  // !i i+1
  var_std__plus, 2, var_138_9_i, num_1, 1, var_138_9_i,
  // is_defined && item.is_a_tuple:
  var_is_defined, 1, var_142_1_item, 1, LOCAL(1),
  // is_defined && item.is_a_tuple:
...
static TAB_NUM t_lambda_25[] = {
  ...
  0, // parameters
  // is_a_tuple:
  var_is_a_tuple, 1, var_142_1_item, 1, LOCAL(1),
  // item.is_a_tuple:
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(145, 35),
  POS(145, 30)
...
static TAB_NUM t_lambda_26[] = {
  ...
  0, // parameters
  // item $type $argument
  var_142_1_item, 0, 2, var_146_6_type, var_146_12_argument,
  // is_an_integer:
  var_is_an_integer, 1, var_146_12_argument, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_argument_is_an_integer[] = {
  ...
  func_fetch, 2, var_138_9_i, var_146_12_argument, 2, var_138_9_i, LOCAL(3),
  // deserializer_of(type)(type arguments)
  var_deserializer_of, 1, var_146_6_type, 1, LOCAL(1),
  // deserializer_of(type)(type arguments)
  LOCAL(1), 2, var_146_6_type, LOCAL(3), 1, LOCAL(2),
  // push &items deserializer_of(type)(type arguments)
  var_push, 2, var_139_1_items, LOCAL(2), 1, var_139_1_items,
  // next
  var_next, 0, TAIL_CALL,
  POS(149, 17),
  POS(150, 29),
...
static TAB_NUM t_lambda_27[] = {
  ...
  var_deserializer_of, 1, var_146_6_type, 1, LOCAL(1),
  // deserializer_of(type)(type argument)
  LOCAL(1), 2, var_146_6_type, var_146_12_argument, 1, LOCAL(2),
...
static TAB_NUM t_lambda_28[] = {
  ...
  0, // parameters
  // push &items item
  var_push, 2, var_139_1_items, var_142_1_item, 1, var_139_1_items,
  // next
  var_next, 0, TAIL_CALL,
  POS(156, 13),
  POS(157, 13)
...
static TAB_NUM t_lambda_29[] = {
  ...
  0, // parameters
  //  i items
  LET, 2, var_138_9_i, var_139_1_items, TAIL_CALL,
  POS(158, 9)
};

static int value_range_102_1_arguments[] = {
  -chr_48, -chr_57
};
...
static FUNKY_CONSTANT constants_table[] = {
  ...
  {FLT_VALUE_RANGE, 2, {.arguments = value_range_102_1_arguments}},
