...
enum {
  ...
  var_36_0_indent, // dynamic
  var_undefined, // extern
  var_to_string, // extern
  var_38_1_str, // dynamic
...
static TAB_NUM t_func_std_types__unique_item___serialize[] = {
  2, // locals
  -2, // parameters
  MANDATORY_PARAMETER, LOCAL(2), // 35_0_self
  var_undefined, var_36_0_indent,
  // to_string)>
  var_to_string, 1, LOCAL(2), 1, LOCAL(1),
  // $str "
  var_std__string, 3, string_1, LOCAL(1), string_2, 1, var_38_1_str,
  // is_defined
  var_is_defined, 1, var_36_0_indent, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_1[] = {
  ...
  var_tabs_and_spaces, 1, var_36_0_indent, 1, LOCAL(1),
  // append(tabs_and_spaces(indent) str)
  var_append, 2, LOCAL(1), var_38_1_str, 1, LOCAL(2),
  //  append(tabs_and_spaces(indent) str)
