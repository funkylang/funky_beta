...
enum {
  ...
  var_953_29_out_fd, // dynamic
  var_953_37_err_fd, // dynamic
  var_create_process, // extern
  var_955_1_io, // dynamic
  var_std_types__io, // extern
  var_join_process, // extern
  var_start_reading_from, // extern
  var_960_1_out, // dynamic
  var_961_1_err, // dynamic
  var_get_events, // extern
  var_965_13_fd, // dynamic
  var_965_17_data, // dynamic
  var_READ, // extern
  var_stop_reading_from, // extern
  var_case, // extern
  var_PROCESS_JOINED, // extern
  var_994_1_ret, // dynamic
  ...
  var_1038_0_indent, // dynamic
  var_1040_1_str, // dynamic
  ...
  var_1077_0_indent, // dynamic
  var_1079_1_str, // dynamic
  ...
  var_1106_0_args, // dynamic
  var_1108_1_i, // dynamic
  var_1109_1_n, // dynamic
  var_1110_1_in_fd, // dynamic
  var_1111_1_feed, // dynamic
  var_1112_1_commands, // dynamic
  var_1113_1_head, // dynamic
  var_1114_1_arguments, // dynamic
  var_1115_1_first_arg, // dynamic
  var_is_a_string, // extern
  var_1135_1_arg, // dynamic
  var_is_a_function, // extern
  var_tuple, // extern
  var_inc, // extern
  var_std__pipe_commands, // initialized
  var_1155_0_feed_or_fd, // dynamic
  var_1156_0_commands, // dynamic
  var_1170_0_in_fd, // dynamic
  var_1171_0_feed, // dynamic
  var_1172_0_commands, // dynamic
  var_1174_1_pids, // dynamic
  var_empty_hash_table, // extern
  var_1175_1_err_fds, // dynamic
  var_1176_1_out_fd, // dynamic
  var_1177_1_env_vars, // dynamic
  var_1186_3_idx, // dynamic
  var_1187_9_head, // dynamic
  var_1187_15_arguments, // dynamic
  var_1189_1_pid, // dynamic
  var_1190_1_err_fd, // dynamic
  var_is_undefined, // extern
  var_std__and, // extern
  var_list, // extern
  var_1204_1_ret, // dynamic
  var_dup, // extern
  var_1205_1_out, // dynamic
  var_1206_1_err, // dynamic
  var_1217_1_read_descriptor_list, // dynamic
  var_keys_of, // extern
  var_1227_1_read_descriptors, // dynamic
  var_1228_1_write_descriptors, // dynamic
  var_pselect, // extern
  var_CHILD_CHANGED_STATE, // extern
  var_1236_8_rpid, // dynamic
  var_1236_14_status, // dynamic
  var_wait2, // extern
  var_1261_3_read_descriptor, // dynamic
  var_1262_7_buf, // dynamic
...
static TAB_NUM t_lambda_3_loop[] = {
  ...
  var_read, 2, var_593_0_fd, num_1048576, IO_CALL(1), var_597_7_buf,
  // cond
...
static TAB_NUM t_func_std__call[] = {
  ...
  var_create_process, 3, LOCAL(3), LOCAL(4), var_945_1_env_vars, IO_CALL(4), LOCAL(5), LOCAL(6), var_953_29_out_fd, var_953_37_err_fd,
  // close! in_fd
  var_close, 1, LOCAL(6), IO_CALL(0),
  // $io std_types::io
  LET, 1, var_std_types__io, 1, var_955_1_io,
  // join_process &io pid
  var_join_process, 2, var_955_1_io, LOCAL(5), 1, var_955_1_io,
  // start_reading_from &io out_fd
  var_start_reading_from, 2, var_955_1_io, var_953_29_out_fd, 1, var_955_1_io,
  // start_reading_from &io err_fd
  var_start_reading_from, 2, var_955_1_io, var_953_37_err_fd, 1, var_955_1_io,
  // $out ""
  LET, 1, string_1, 1, var_960_1_out,
  // $err ""
  LET, 1, string_1, 1, var_961_1_err,
  // loop:
...
static TAB_NUM t_lambda_5_loop[] = {
  ...
  var_get_events, 1, var_955_1_io, IO_CALL(2), var_955_1_io, LOCAL(1),
...
static TAB_NUM t_lambda_30[] = {
  2, // locals
  1, // parameters
  LOCAL(1), // 964_18_event
  // event $type $fd $data
  LOCAL(1), 0, 3, LOCAL(2), var_965_13_fd, var_965_17_data,
  // case type
...
static TAB_NUM t_lambda_READ[] = {
  ...
  0, // parameters
  // data == "":
  var_std__equal, 2, var_965_17_data, string_1, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_31[] = {
  ...
  0, // parameters
  // close! fd
  var_close, 1, var_965_13_fd, IO_CALL(0),
  // stop_reading_from &io fd
  var_stop_reading_from, 2, var_955_1_io, var_965_13_fd, 1, var_955_1_io,
  // next!
  var_next, 0, IO_TAIL_CALL,
  POS(970, 15),
  POS(971, 15),
...
static TAB_NUM t_lambda_32[] = {
  ...
  0, // parameters
  // case fd
  var_case, 6, var_965_13_fd, var_953_29_out_fd, lambda_out_fd, var_953_37_err_fd, lambda_err_fd, lambda_35, IO_TAIL_CALL,
  POS(974, 15)
};
...
static TAB_NUM t_lambda_out_fd[] = {
  ...
  0, // parameters
  // if
  var_if, 3, var_943_1_do_collect_output, lambda_do_collect_output, lambda_33, IO_TAIL_CALL,
  POS(976, 19)
};
...
static TAB_NUM t_lambda_do_collect_output[] = {
  ...
  0, // parameters
  // append &out data
  var_append, 2, var_960_1_out, var_965_17_data, 1, var_960_1_out,
  // next!
  var_next, 0, IO_TAIL_CALL,
  POS(978, 23),
  POS(979, 23)
...
static TAB_NUM t_lambda_33[] = {
  ...
  var_write_to, 2, var_STDOUT_FILENO, var_965_17_data, IO_CALL(0),
  // next!
  var_next, 0, IO_TAIL_CALL,
  POS(981, 23),
  POS(982, 23)
...
static TAB_NUM t_lambda_err_fd[] = {
  ...
  0, // parameters
  // if
  var_if, 3, var_944_1_do_collect_error_output, lambda_do_collect_error_output, lambda_34, IO_TAIL_CALL,
  POS(984, 19)
};
...
static TAB_NUM t_lambda_do_collect_error_output[] = {
  ...
  0, // parameters
  // append &err data
  var_append, 2, var_961_1_err, var_965_17_data, 1, var_961_1_err,
  // next!
  var_next, 0, IO_TAIL_CALL,
  POS(986, 23),
  POS(987, 23)
...
static TAB_NUM t_lambda_34[] = {
  ...
  var_write_to, 2, var_STDERR_FILENO, var_965_17_data, IO_CALL(0),
  // next!
  var_next, 0, IO_TAIL_CALL,
  POS(989, 23),
  POS(990, 23)
...
static TAB_NUM t_lambda_PROCESS_JOINED[] = {
  ...
  0, // parameters
  // $ret data
  LET, 1, var_965_17_data, 1, var_994_1_ret,
  // if
  var_if, 3, var_943_1_do_collect_output, lambda_2_do_collect_output, lambda_38, TAIL_CALL,
  POS(994, 11),
  POS(995, 11)
};
...
static TAB_NUM t_lambda_2_do_collect_output[] = {
  ...
  0, // parameters
  // if
  var_if, 3, var_944_1_do_collect_error_output, lambda_36, lambda_37, TAIL_CALL,
  POS(997, 15)
};
...
static TAB_NUM t_lambda_36[] = {
  ...
  0, // parameters
  //  ret out err
  LET, 3, var_994_1_ret, var_960_1_out, var_961_1_err, TAIL_CALL,
  POS(999, 19)
};
...
static TAB_NUM t_lambda_37[] = {
  ...
  0, // parameters
  //  ret out
  LET, 2, var_994_1_ret, var_960_1_out, TAIL_CALL,
  POS(1000, 19)
};
...
static TAB_NUM t_func_std_types__file_descriptor___serialize[] = {
  2, // locals
  -2, // parameters
  MANDATORY_PARAMETER, LOCAL(2), // 1037_0_self
  var_undefined, var_1038_0_indent,
  // to_integer)
  var_to_integer, 1, LOCAL(2), 1, LOCAL(1),
  // $str "
  var_std__string, 3, str_file_descriptor_2, LOCAL(1), string_3, 1, var_1040_1_str,
  // is_defined
  var_is_defined, 1, var_1038_0_indent, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_40[] = {
  ...
  var_tabs_and_spaces, 1, var_1038_0_indent, 1, LOCAL(1),
  // append(tabs_and_spaces(indent) str)
  var_append, 2, LOCAL(1), var_1040_1_str, 1, LOCAL(2),
  //  append(tabs_and_spaces(indent) str)
  LET, 1, LOCAL(2), TAIL_CALL,
  POS(1044, 15),
  POS(1044, 8),
...
static TAB_NUM t_lambda_41[] = {
  ...
  0, // parameters
  //  str
  LET, 1, var_1040_1_str, TAIL_CALL,
  POS(1045, 7)
};
...
static TAB_NUM t_func_std_types__process_id___serialize[] = {
  2, // locals
  -2, // parameters
  MANDATORY_PARAMETER, LOCAL(2), // 1076_0_self
  var_undefined, var_1077_0_indent,
  // to_integer)
  var_to_integer, 1, LOCAL(2), 1, LOCAL(1),
  // $str "
  var_std__string, 3, str_process_id_2, LOCAL(1), string_3, 1, var_1079_1_str,
  // is_defined
  var_is_defined, 1, var_1077_0_indent, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_42[] = {
  ...
  0, // parameters
  // tabs_and_spaces(indent) str)
  var_tabs_and_spaces, 1, var_1077_0_indent, 1, LOCAL(1),
  // append(tabs_and_spaces(indent) str)
  var_append, 2, LOCAL(1), var_1079_1_str, 1, LOCAL(2),
  //  append(tabs_and_spaces(indent) str)
  LET, 1, LOCAL(2), TAIL_CALL,
  POS(1083, 15),
  POS(1083, 8),
...
static TAB_NUM t_lambda_43[] = {
  ...
  0, // parameters
  //  str
  LET, 1, var_1079_1_str, TAIL_CALL,
  POS(1084, 7)
};
...
static TAB_NUM t_func_extern_call[] = {
  5, // locals
  -2, // parameters
  MYSELF_PARAMETER, LOCAL(4), // 1099_0_myself
  REST_PARAMETER, LOCAL(5), // 1100_0_arguments
...
static TAB_NUM t_func_std__pipe[] = {
  1, // locals
  -1, // parameters
  REST_PARAMETER, var_1106_0_args,
  // $i 1
  LET, 1, num_1, 1, var_1108_1_i,
  // $n length_of(args)
  var_length_of, 1, var_1106_0_args, 1, var_1109_1_n,
  // $in_fd undefined
  LET, 1, var_undefined, 1, var_1110_1_in_fd,
  // $feed undefined
  LET, 1, var_undefined, 1, var_1111_1_feed,
  // $commands empty_list
  LET, 1, var_empty_list, 1, var_1112_1_commands,
  // $head undefined
  LET, 1, var_undefined, 1, var_1113_1_head,
  // $arguments undefined
  LET, 1, var_undefined, 1, var_1114_1_arguments,
  // $first_arg args(1)
  var_1106_0_args, 1, num_1, 1, var_1115_1_first_arg,
  // is_a_string:
  var_is_a_string, 1, var_1115_1_first_arg, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_first_arg_is_a_string[] = {
  ...
  0, // parameters
  // !feed first_arg
  LET, 1, var_1115_1_first_arg, 1, var_1111_1_feed,
  // !i 2
  LET, 1, num_2, 1, var_1108_1_i,
  // build_commands!
...
static TAB_NUM t_lambda_44[] = {
  ...
  var_is_a_file_descriptor, 1, var_1115_1_first_arg, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_first_arg_is_a_file_descriptor[] = {
  ...
  0, // parameters
  // !in_fd first_arg
  LET, 1, var_1115_1_first_arg, 1, var_1110_1_in_fd,
  // !i 2
  LET, 1, num_2, 1, var_1108_1_i,
  // build_commands!
  func_build_commands, 0, IO_TAIL_CALL,
...
static TAB_NUM t_lambda_45[] = {
  ...
  0, // parameters
  // n break
  var_std__less, 2, var_1109_1_n, var_1108_1_i, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_46[] = {
  ...
  0, // parameters
  // $arg args(i)
  var_1106_0_args, 1, var_1108_1_i, 1, var_1135_1_arg,
  // is_a_function:
  var_is_a_function, 1, var_1135_1_arg, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_arg_is_a_function[] = {
  ...
  0, // parameters
  // is_defined &commands:
  var_is_defined, 1, var_1113_1_head, 1, LOCAL(1),
  // update_if head.is_defined &commands:
  var_update_if, 3, LOCAL(1), var_1112_1_commands, lambda_47, 1, var_1112_1_commands,
  // !head command_of(arg)
  var_command_of, 1, var_1135_1_arg, 1, var_1113_1_head,
  // !arguments empty_list
  LET, 1, var_empty_list, 1, var_1114_1_arguments,
  // inc &i
  var_inc, 1, var_1108_1_i, 1, var_1108_1_i,
  // next!
  var_next, 0, IO_TAIL_CALL,
  POS(1138, 32),
  POS(1138, 17),
...
static TAB_NUM t_lambda_48[] = {
  ...
  0, // parameters
  // push &arguments arg
  var_push, 2, var_1114_1_arguments, var_1135_1_arg, 1, var_1114_1_arguments,
  // inc &i
  var_inc, 1, var_1108_1_i, 1, var_1108_1_i,
  // next!
  var_next, 0, IO_TAIL_CALL,
...
static TAB_NUM t_lambda_49[] = {
  ...
  var_is_defined, 1, var_1113_1_head, 1, LOCAL(1),
  // update_if head.is_defined &commands:
  var_update_if, 3, LOCAL(1), var_1112_1_commands, lambda_50, 1, var_1112_1_commands,
  // run_pipe! in_fd feed commands
  func_run_pipe, 3, var_1110_1_in_fd, var_1111_1_feed, var_1112_1_commands, IO_TAIL_CALL,
  POS(1149, 24),
  POS(1149, 9),
  POS(1151, 9)
};
...
static TAB_NUM t_func_std__pipe_commands[] = {
  1, // locals
  -2, // parameters
  var_undefined, var_1155_0_feed_or_fd,
  MANDATORY_PARAMETER, var_1156_0_commands,
  // is_defined:
  var_is_defined, 1, var_1155_0_feed_or_fd, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_feed_or_fd_is_defined[] = {
  ...
  0, // parameters
  // is_a_file_descriptor:
  var_is_a_file_descriptor, 1, var_1155_0_feed_or_fd, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_feed_or_fd_is_a_file_descriptor[] = {
  ...
  func_run_pipe, 3, var_1155_0_feed_or_fd, var_undefined, var_1156_0_commands, IO_TAIL_CALL,
  POS(1162, 11)
};
...
static TAB_NUM t_lambda_51[] = {
  ...
  func_run_pipe, 3, var_undefined, var_1155_0_feed_or_fd, var_1156_0_commands, IO_TAIL_CALL,
  POS(1164, 11)
};
...
static TAB_NUM t_lambda_52[] = {
  ...
  func_run_pipe, 3, var_undefined, var_undefined, var_1156_0_commands, IO_TAIL_CALL,
  POS(1166, 7)
};
...
static TAB_NUM t_func_run_pipe[] = {
  ...
  LET, 1, var_empty_hash_table, 1, var_1174_1_pids,
  // $err_fds empty_hash_table
  LET, 1, var_empty_hash_table, 1, var_1175_1_err_fds,
  // $out_fd in_fd
  LET, 1, var_1170_0_in_fd, 1, var_1176_1_out_fd,
  // $env_vars undefined
  LET, 1, var_undefined, 1, var_1177_1_env_vars,
  // is_defined &env_vars:
  var_is_defined, 1, var_environment, 1, LOCAL(1),
  // update_if environment.is_defined &env_vars:
  var_update_if, 3, LOCAL(1), var_1177_1_env_vars, lambda_53, 1, var_1177_1_env_vars,
  // for_each commands
  var_for_each, 3, var_1172_0_commands, lambda_56, lambda_60, IO_TAIL_CALL,
  POS(1174, 3),
  POS(1175, 3),
  POS(1176, 3),
  POS(1177, 3),
...
static TAB_NUM t_lambda_53[] = {
  ...
  0, // parameters
  // !env_vars empty_list
  LET, 1, var_empty_list, 1, var_1177_1_env_vars,
  // for_each environment
...
static TAB_NUM t_lambda_54[] = {
  ...
  2, // parameters
  LOCAL(2), // 1181_3_key
  LOCAL(3), // 1181_7_value
  // "@(key)=@(value)"
  var_std__string, 3, LOCAL(2), string_2, LOCAL(3), 1, LOCAL(1),
  // push &env_vars "@(key)=@(value)"
  var_push, 2, var_1177_1_env_vars, LOCAL(1), 1, var_1177_1_env_vars,
  // next
  var_next, 0, TAIL_CALL,
  POS(1182, 24),
  POS(1182, 9),
...
static TAB_NUM t_lambda_55[] = {
  ...
  0, // parameters
  //  env_vars
  LET, 1, var_1177_1_env_vars, TAIL_CALL,
  POS(1184, 9)
};
...
static TAB_NUM t_lambda_56[] = {
  ...
  2, // parameters
  var_1186_3_idx,
  LOCAL(3), // 1186_7_command
  // command $head $arguments
  LOCAL(3), 0, 2, var_1187_9_head, var_1187_15_arguments,
  // map &arguments to_utf8
  var_map, 2, var_1187_15_arguments, var_to_utf8, 1, var_1187_15_arguments,
  // $pid undefined
  LET, 1, var_undefined, 1, var_1189_1_pid,
  // $err_fd undefined
  LET, 1, var_undefined, 1, var_1190_1_err_fd,
  // idx == 1 && in_fd.is_undefined:
  var_std__equal, 2, var_1186_3_idx, num_1, 1, LOCAL(1),
  // idx == 1 && in_fd.is_undefined:
...
static TAB_NUM t_lambda_57[] = {
  ...
  0, // parameters
  // is_undefined:
  var_is_undefined, 1, var_1170_0_in_fd, 1, LOCAL(1),
  // in_fd.is_undefined:
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(1192, 27),
  POS(1192, 21)
...
static TAB_NUM t_lambda_58[] = {
  ...
  var_create_process, 3, var_1187_9_head, var_1187_15_arguments, var_1177_1_env_vars, IO_CALL(4), var_1189_1_pid, var_1170_0_in_fd, var_1176_1_out_fd, var_1190_1_err_fd,
...
static TAB_NUM t_lambda_59[] = {
  ...
  var_create_process, 4, var_1187_9_head, var_1187_15_arguments, var_1177_1_env_vars, var_1176_1_out_fd, IO_CALL(3), var_1189_1_pid, var_1176_1_out_fd, var_1190_1_err_fd,
  // store_pid_and_err_fd!
  func_store_pid_and_err_fd, 0, IO_TAIL_CALL,
  POS(1196, 11),
  POS(1197, 11)
...
static TAB_NUM t_func_store_pid_and_err_fd[] = {
  ...
  0, // parameters
  // pids(pid) idx
  var_1174_1_pids, 2, var_1189_1_pid, var_1186_3_idx, 1, var_1174_1_pids,
  // err_fds(err_fd) idx
  var_1175_1_err_fds, 2, var_1190_1_err_fd, var_1186_3_idx, 1, var_1175_1_err_fds,
  // next!
  var_next, 0, IO_TAIL_CALL,
  POS(1200, 10),
  POS(1201, 10),
...
static TAB_NUM t_lambda_60[] = {
  ...
  // length_of(commands))
  var_length_of, 1, var_1172_0_commands, 1, LOCAL(2),
  // $ret dup(list(undefined) length_of(commands))
  var_dup, 2, LOCAL(1), LOCAL(2), 1, var_1204_1_ret,
  // $out ""
  LET, 1, string_1, 1, var_1205_1_out,
  // length_of(commands))
  var_length_of, 1, var_1172_0_commands, 1, LOCAL(2),
  // $err dup(list("") length_of(commands))
  var_dup, 2, list_1206_9, LOCAL(2), 1, var_1206_1_err,
  // is_defined
  var_is_defined, 1, var_1171_0_feed, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_61[] = {
  ...
  0, // parameters
  // close! in_fd
  var_close, 1, var_1170_0_in_fd, IO_CALL(0),
  // !in_fd undefined
  LET, 1, var_undefined, 1, var_1170_0_in_fd,
  // manage_io!
...
static TAB_NUM t_lambda_6_loop[] = {
  ...
  var_keys_of, 1, var_1175_1_err_fds, 1, var_1217_1_read_descriptor_list,
  // is_defined
  var_is_defined, 1, var_1170_0_in_fd, 1, LOCAL(1),
  // $write_descriptor_list
  var_if, 3, LOCAL(1), lambda_62, lambda_63, 1, LOCAL(2),
  // is_defined &read_descriptor_list:
  var_is_defined, 1, var_1176_1_out_fd, 1, LOCAL(1),
  // update_if out_fd.is_defined &read_descriptor_list:
  var_update_if, 3, LOCAL(1), var_1217_1_read_descriptor_list, lambda_64, 1, var_1217_1_read_descriptor_list,
  // pselect!
  var_pselect, 3, var_1217_1_read_descriptor_list, LOCAL(2), var_empty_list, IO_CALL(4), LOCAL(3), var_1227_1_read_descriptors, var_1228_1_write_descriptors, LOCAL(1),
  // for_each signals
...
static TAB_NUM t_lambda_62[] = {
  ...
  0, // parameters
  // list(in_fd)
  var_list, 1, var_1170_0_in_fd, 1, LOCAL(1),
  //  list(in_fd)
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(1221, 18),
  POS(1221, 17)
...
static TAB_NUM t_lambda_64[] = {
  ...
  var_push, 2, var_1217_1_read_descriptor_list, var_1176_1_out_fd, TAIL_CALL,
  POS(1224, 13)
};
...
static TAB_NUM t_lambda_67[] = {
  ...
  0, // parameters
  // wait2! $rpid $status
  var_wait2, 0, IO_CALL(2), var_1236_8_rpid, var_1236_14_status,
  // is_defined:
  var_is_defined, 1, var_1236_8_rpid, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_rpid_is_defined[] = {
  ...
  0, // parameters
  // pids(rpid)) status
  var_1174_1_pids, 1, var_1236_8_rpid, 1, LOCAL(2),
  // ret(pids(rpid)) status
  var_1204_1_ret, 2, LOCAL(2), var_1236_14_status, 1, var_1204_1_ret,
  // pids(rpid) undefined
  var_1174_1_pids, 2, var_1236_8_rpid, var_undefined, 1, var_1174_1_pids,
  // is_empty
  var_is_empty, 1, var_1174_1_pids, 1, LOCAL(1),
  // if!
...
static TAB_NUM t_lambda_68[] = {
  ...
  var_for_each, 3, var_1228_1_write_descriptors, lambda_69, lambda_70, IO_TAIL_CALL,
  POS(1249, 15)
};
...
static TAB_NUM t_lambda_69[] = {
  3, // locals
  1, // parameters
  LOCAL(2), // 1250_3_write_descriptor
  // write! $bytes_written write_descriptor feed
  var_write, 2, LOCAL(2), var_1171_0_feed, IO_CALL(1), LOCAL(3),
  // bytes_written+1 -1
  var_std__plus, 2, LOCAL(3), num_1, 1, LOCAL(1),
  // range &feed bytes_written+1 -1
  var_range, 3, var_1171_0_feed, LOCAL(1), minus_num_1, 1, var_1171_0_feed,
  // is_empty:
  var_is_empty, 1, var_1171_0_feed, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_70[] = {
  ...
  var_for_each, 3, var_1227_1_read_descriptors, lambda_71, lambda_77, IO_TAIL_CALL,
  POS(1260, 19)
};
...
static TAB_NUM t_lambda_71[] = {
  1, // locals
  1, // parameters
  var_1261_3_read_descriptor,
  // read! $buf read_descriptor 0x100000
  var_read, 2, var_1261_3_read_descriptor, num_1048576, IO_CALL(1), var_1262_7_buf,
  // is_empty: # closed from the other side
  var_is_empty, 1, var_1262_7_buf, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_buf_is_empty[] = {
  ...
  var_close, 1, var_1261_3_read_descriptor, IO_CALL(0),
  // read_descriptor == out_fd:
  var_std__equal, 2, var_1261_3_read_descriptor, var_1176_1_out_fd, 1, LOCAL(1),
  // if
...
static TAB_NUM t_lambda_72[] = {
  ...
  0, // parameters
  // !out_fd undefined
  LET, 1, var_undefined, 1, var_1176_1_out_fd,
  // next!
  var_next, 0, IO_TAIL_CALL,
  POS(1268, 31),
  POS(1269, 31)
...
static TAB_NUM t_lambda_73[] = {
  ...
  var_1175_1_err_fds, 2, var_1261_3_read_descriptor, var_undefined, 1, var_1175_1_err_fds,
  // next!
  var_next, 0, IO_TAIL_CALL,
  POS(1271, 32),
  POS(1272, 31)
...
static TAB_NUM t_lambda_75[] = {
  ...
  0, // parameters
  // append &out buf
  var_append, 2, var_1205_1_out, var_1262_7_buf, 1, var_1205_1_out,
  // next!
  var_next, 0, IO_TAIL_CALL,
  POS(1276, 31),
  POS(1277, 31)
...
static TAB_NUM t_lambda_76[] = {
  ...
  var_1175_1_err_fds, 1, var_1261_3_read_descriptor, 1, LOCAL(1),
  // err(err_fds(read_descriptor)) buf
  var_1206_1_err, 1, LOCAL(1), 1, LOCAL(2),
  // append &err(err_fds(read_descriptor)) buf
  var_append, 2, LOCAL(2), var_1262_7_buf, 1, LOCAL(2),
  // err(err_fds(read_descriptor)) buf
  var_1206_1_err, 2, LOCAL(1), LOCAL(2), 1, var_1206_1_err,
  // next!
  var_next, 0, IO_TAIL_CALL,
  POS(1279, 43),
  POS(1279, 39),
...
static TAB_NUM t_lambda_78[] = {
  ...
  var_is_undefined, 1, var_1176_1_out_fd, 1, LOCAL(1),
  // is_undefined && err_fds.is_empty
...
static TAB_NUM t_lambda_79[] = {
  ...
  0, // parameters
  // is_empty
  var_is_empty, 1, var_1175_1_err_fds, 1, LOCAL(1),
  // err_fds.is_empty
  LET, 1, LOCAL(1), TAIL_CALL,
  POS(1283, 73),
  POS(1283, 65)
...
static TAB_NUM t_lambda_80[] = {
  ...
  0, // parameters
  //  ret out err
  LET, 3, var_1204_1_ret, var_1205_1_out, var_1206_1_err, TAIL_CALL,
  POS(1284, 27)
};
...
static int list_1206_9_arguments[] = {
  -string_1
};
...
static FUNKY_CONSTANT constants_table[] = {
  ...
  {FLT_LIST, 1, {.arguments = list_1206_9_arguments}},
...
static FUNKY_VARIABLE variables_table[] = {
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "953_29_out_fd\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "953_37_err_fd\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
  ...
  },
  {
    FOT_UNKNOWN, 0, 0,
    "false\000", NULL,
    {.position = POS(1021, 41)}
  },
  {
    FOT_UNKNOWN_POLYMORPHIC, 0, 0,
    "serialization_tag_of\000", NULL,
    {.position = POS(1029, 29)}
  },
  {
    FOT_UNKNOWN_POLYMORPHIC, 0, 0,
    "serialize\000", NULL,
    {.position = POS(1033, 29)}
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1038_0_indent\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1040_1_str\000", NULL
  },
  {
    ...
    {.position = POS(1044, 15)}
  },
  {
    FOT_UNKNOWN_POLYMORPHIC, 0, 0,
    "deserializer_of\000", NULL,
    {.position = POS(1047, 29)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "integer\000", NULL,
    {.position = POS(1054, 22)}
  },
  {
    FOT_UNKNOWN, 0, 0,
  ...
  },
  {
    FOT_UNKNOWN, 0, 0,
    "flatten\000", NULL,
    {.position = POS(1102, 32)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "to_string\000", NULL,
    {.position = POS(1102, 51)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "map\000", NULL,
    {.position = POS(1102, 28)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "call\000", NULL,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "1110_1_in_fd\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1111_1_feed\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1112_1_commands\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1113_1_head\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1114_1_arguments\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1115_1_first_arg\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "is_a_string\000", NULL,
    {.position = POS(1117, 15)}
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1135_1_arg\000", NULL
  },
  {
    ...
    {.position = POS(1137, 19)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "tuple\000", NULL,
    {.position = POS(1139, 33)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "inc\000", NULL,
    {.position = POS(1142, 17)}
  },
  {
    FOT_INITIALIZED, 0, 0,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "1155_0_feed_or_fd\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1156_0_commands\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1170_0_in_fd\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1171_0_feed\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1172_0_commands\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1174_1_pids\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "1175_1_err_fds\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1176_1_out_fd\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1177_1_env_vars\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1186_3_idx\000", NULL
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "1187_9_head\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1187_15_arguments\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1189_1_pid\000", NULL
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "1190_1_err_fd\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "is_undefined\000", NULL,
    {.position = POS(1192, 27)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "and\000std", NULL,
  ...
  {
    FOT_UNINITIALIZED, 0, 0,
    "1217_1_read_descriptor_list\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "keys_of\000", NULL,
    {.position = POS(1217, 33)}
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1227_1_read_descriptors\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1228_1_write_descriptors\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "pselect\000", NULL,
    {.position = POS(1225, 11)}
  },
  {
    FOT_UNKNOWN, 0, 0,
    "CHILD_CHANGED_STATE\000", NULL,
    {.position = POS(1233, 27)}
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1236_8_rpid\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1236_14_status\000", NULL
  },
  {
    FOT_UNKNOWN, 0, 0,
    "wait2\000", NULL,
    {.position = POS(1236, 23)}
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1261_3_read_descriptor\000", NULL
  },
  {
    FOT_UNINITIALIZED, 0, 0,
    "1262_7_buf\000", NULL
